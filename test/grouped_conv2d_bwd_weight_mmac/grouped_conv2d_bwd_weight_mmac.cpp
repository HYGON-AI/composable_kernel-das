...
{
    public:
    TestGroupedConvNdBwdWeight() : ::testing::Test()
    {
        conv_params.clear();
...
TEST_F(TestGroupedConvNdBwdWeight, GroupedConv2dBwdWeightNHWGC_F16)
{
...
TEST_F(TestGroupedConvNdBwdWeight, GroupedConv2dBwdWeightNHWGC_BF16)
{
    for(auto& param : conv_params)
    {
        bool pass;
...
TEST_F(TestGroupedConvNdBwdWeight, GroupedConv2dBwdWeightNHWGC_F32)
{
    for(auto& param : conv_params)
    {
        bool pass;
...
TEST_F(TestGroupedConvNdBwdWeight, GroupedConv2dBwdWeightNGCHW_F16)
{
    for(auto& param : conv_params)
    {
        bool pass;
...
TEST_F(TestGroupedConvNdBwdWeight, GroupedConv2dBwdWeightNGCHW_BF16)
{
    for(auto& param : conv_params)
    {
        bool pass;
...
TEST_F(TestGroupedConvNdBwdWeight, GroupedConv2dBwdWeightNGCHW_F32)
{
    for(auto& param : conv_params)
    {
        bool pass;
...
TEST_F(TestGroupedConvNdBwdWeight, GroupedConv2dBwdWeightNGCHWc32_F16)
{
    for(auto& param : conv_params)
    {
        bool pass;
...
TEST_F(TestGroupedConvNdBwdWeight, GroupedConv2dBwdWeightNGCHWc16_F16)
{
    for(auto& param : conv_params)
    {
        bool pass;
