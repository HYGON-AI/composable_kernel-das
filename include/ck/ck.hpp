...
#include "ck/config.h"
#include "ck/utility/index_type.hpp"
...
#elif defined(__gfx803__) || defined(__gfx900__) || defined(__gfx906__) || defined(__gfx916__) || \
    defined(__gfx926__) || defined(__gfx928__) || defined(__gfx92a__) || defined(__gfx936__) ||   \
    defined(__gfx938__) || defined(__gfx946__) || defined(__gfx908__) || defined(__gfx90a__) ||   \
...
#elif defined(__gfx906__) || defined(__gfx916__) || defined(__gfx926__) || defined(__gfx928__) || \
    defined(__gfx92a__) || defined(__gfx936__) || defined(__gfx938__) || defined(__gfx908__) ||   \
    defined(__gfx90a__) || defined(__gfx1030__) || defined(__gfx940__) // for GPU code
...
// Hygon HCU (MMAC). Device compile only; host compilation does not define __gfx9xx__.
#if defined(__gfx926__) || defined(__gfx928__) || defined(__gfx92a__) || \
    defined(__gfx936__) || defined(__gfx938__) || defined(__gfx946__)
#define CK_ARCH_HCU 1
#endif
...
#elif defined(__gfx908__) || defined(__gfx90a__) || defined(__gfx940__) || defined(__gfx928__) || \
    defined(__gfx92a__) || defined(__gfx936__) // for GPU code
#define CK_USE_AMD_BUFFER_ATOMIC_ADD_FLOAT 1
#else // for GPU code
#define CK_USE_AMD_BUFFER_ATOMIC_ADD_FLOAT 0
#endif

// hcu buffer atomic add: float
#ifndef __HIP_DEVICE_COMPILE__ // for host code
#define CK_USE_HCU_BUFFER_ATOMIC_ADD_F32 1
#elif defined(__gfx926__) || defined(__gfx928__) || defined(__gfx92a__) || defined(__gfx936__) || \
    defined(__gfx938__) // for GPU code
#define CK_USE_HCU_BUFFER_ATOMIC_ADD_F32 1
#else
#define CK_USE_HCU_BUFFER_ATOMIC_ADD_F32 0
#endif
...
#endif
#define CK_EXPERIMENTAL_USE_BUFFER_STORE_OOB_CHECK_OFFSET_TRICK 0
#define CK_EXPERIMENTAL_USE_BUFFER_ATOMIC_ADD_OOB_CHECK_OFFSET_TRICK 0
#define CK_EXPERIMENTAL_USE_BUFFER_ATOMIC_MAX_OOB_CHECK_OFFSET_TRICK 0
...
// hack: disable gfx928 cshuffle kernel for subsequent devices
// TODO: figure out root cause of this issue
#define CK_HACK_DISABLE_GFX928_CSHUFFLE_INSTANCE_FOR_SUBSEQUENT_DEVICES 1

// whether to use generic buffer load
#if defined(__gfx936__) || defined(__gfx938__)
#define CK_SUPPORT_EXTENDED_BUFFER_LOAD_LDS_DIRECT 1
#else
#define CK_SUPPORT_EXTENDED_BUFFER_LOAD_LDS_DIRECT 0
#endif
