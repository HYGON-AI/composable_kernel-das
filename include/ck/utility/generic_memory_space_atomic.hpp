...
__device__ bhalf4_t atomic_add<bhalf4_t>(bhalf4_t* p_dst, const bhalf4_t& x)
{
    ...
    vy.template AsType<bhalf2_t>()(I0) =
        atomic_add<bhalf2_t>(c_style_pointer_cast<bhalf2_t*>(p_dst),
                             vx.template AsType<bhalf2_t>()[I0]);
    vy.template AsType<bhalf2_t>()(I1) =
        atomic_add<bhalf2_t>(c_style_pointer_cast<bhalf2_t*>(p_dst) + 1,
                             vx.template AsType<bhalf2_t>()[I1]);
