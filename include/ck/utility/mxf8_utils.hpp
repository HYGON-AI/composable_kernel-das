...
// AMD builtins (__builtin_amdgcn_cvt_scale_*) are gated behind architecture guards.
// On HCU, software fallback paths are used by default.
// HCU __builtin_hcu_cvt_scale_* operates on 2-element pairs (pk=2); the pk8 operations
