...
// On HCU (gfx92a+/gfx938+/gfx946+), software fallback paths are used by default.
// HCU builtins (__builtin_hcu_cvt_*) operate on 2-element pairs (pk=2) and can be
// enabled via CK_FP8_HCU_CVT_FAST_PATH once validation is complete.
...
// HCU fast path: disabled by default. Enable once __builtin_hcu_cvt_* sign-offs are complete.
// gfx92a+ has basic FP8/BF8 conversion; gfx938+ adds stochastic rounding; gfx946+ adds scaled SR.
// All HCU conversion builtins operate on 2-element pairs (pk=2).
#if 0 && defined(__gfx92a__) && __HIP_DEVICE_COMPILE__
#define CK_FP8_HCU_CVT_FAST_PATH 1
#else
#define CK_FP8_HCU_CVT_FAST_PATH 0
#endif
