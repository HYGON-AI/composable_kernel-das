...
//
// Adapted for Hygon HCU: workgroup barrier using global memory atomics.
// Uses only standard HIP atomics (atomicCAS, atomicAdd, __syncthreads) —
// no AMD-specific builtins, works on HCU.
