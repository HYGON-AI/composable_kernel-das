...
struct lds_utils
{
     ...
     * \param start_offset_elems Number of elements to move from the start of LDS for the allocation
     * of the first buffer. \param lds_alignment Alignment of every buffer allocation given as a
     * number of elements. \return Tuple of dynamic buffers representing memory allocated in LDS.
     */
