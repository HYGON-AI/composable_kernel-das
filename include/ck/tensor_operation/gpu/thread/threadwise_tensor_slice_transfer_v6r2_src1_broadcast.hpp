...
struct ThreadwiseTensorSliceTransfer_v6r2_src1_broadcast
{
    ...
    __device__ constexpr ThreadwiseTensorSliceTransfer_v6r2_src1_broadcast(
                        ...
                        DstBuffer& dst_buf)
    {
        ...
        static_for<0, num_access, 1>{}([&](auto idx_1d) {
            ...
            using src1_vector_type = vector_type_maker_t<Src1Data, 1>;
            ...
            static_for<0, ScalarPerVector, 1>{}([&](auto i) {
                element_op_(dst_vector_container.template AsType<DstData>()(i),
                            ...
                            src1_vector_container.template AsType<Src1Data>()[Number<0>{}]);
            });
