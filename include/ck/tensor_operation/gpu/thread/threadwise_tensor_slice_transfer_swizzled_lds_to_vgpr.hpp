...
template <typename SrcData,
          ...
          typename enable_if<SrcDesc::IsKnownAtCompileTime() && DstDesc::IsKnownAtCompileTime(),
                             bool>::type = false>
struct ThreadwiseTensorSliceTransfer_SwizzledLds2Vgpr
{
    ...
    __device__ constexpr ThreadwiseTensorSliceTransfer_SwizzledLds2Vgpr(const Index& src_ref_idx)
                        ...
                        DstBuffer& dst_buf) const
    {
        ...
        static_ford<decltype(ordered_access_lengths)>{}([&](auto ordered_access_idx) {
            ...
            src_tmp_vector.template AsType<src_vector_t>()(Number<0>{}) =
                src_buf.template Get<src_vector_t>(swizzle_functor(src_data_coord.GetOffset()),
                                                   is_src_valid);
    ...
    private:
    static constexpr auto swizzle_functor = make_swizzle<sizeof(SrcData) * SrcScalarPerVector>();
