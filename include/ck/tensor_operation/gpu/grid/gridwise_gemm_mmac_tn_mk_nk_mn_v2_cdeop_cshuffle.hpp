...
#include "ck/tensor_operation/gpu/grid/multistage_gemm_pipeline_v2.hpp"
...
template <index_t BlockSize,
          ...
          index_t occupancy>
struct GridwiseGemm_mmac_tn_mk_nk_mn_v2_cdeop_cshuffle
{
    ...
    using MultiStageGemmPipeline =
        remove_cvref_t<decltype(MultiStageGemmPipeline_v2<NumGemmKPrefetchStage,
                                                          ALdsDirectLoad,
                                                          BLdsDirectLoad>())>;
