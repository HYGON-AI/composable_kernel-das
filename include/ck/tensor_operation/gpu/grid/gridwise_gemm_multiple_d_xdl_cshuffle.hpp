...
struct GridwiseGemmMultipleD_xdl_cshuffle
{
                               ...
                               const Block2ETileMap& block_2_etile_map)
    {
        ...
        constexpr index_t KPack = math::max(
            math::lcm(AK1, BK1),
            MmacSelector<AComputeDataType, BComputeDataType, MPerXdl, NPerXdl, KPerBlock>::selected_mmac
                .k_per_blk);
        ...
        // shuffle C and write out
        {
            ...
            // TODO: hacky, fix it!
            // notion: m0_n0_m1_n1_m2_n2_n3_n4 on HCU, see blockwise-gemm-xdlops.
            ...
            // notion: c_block_desc_* actually is m0_n0_m1_n1_m2_n2_n3_n4 on HCU
