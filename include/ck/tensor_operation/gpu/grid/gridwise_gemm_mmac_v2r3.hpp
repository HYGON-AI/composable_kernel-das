...
struct GridwiseGemm_k0mk1_k0nk1_mn_mmac_v2r3
{
    ...
    __host__ __device__ static constexpr index_t GetSharedMemoryNumberOfByte()
    {
        ...
        return (a_block_space_size_aligned * sizeof(AStorageType) +
                  ...
                  const Block2CTileMap& block_2_ctile_map)
    {
        ...
        // currently, our mmac based solution cannot support C vector store with out c shuffle
        static_assert(CThreadTransferDstScalarPerVector == 1,
                      "CThreadTransferDstScalarPerVector != 1");
        ...
        const Block2CTileMap& block_2_ctile_map)
    {
        const auto a_grid_buf = make_dynamic_buffer<AddressSpaceEnum::Global>(
            ...
            a_grid_desc_k0_m_k1.GetElementSpaceSize());
        const auto b_grid_buf = make_dynamic_buffer<AddressSpaceEnum::Global>(
            reinterpret_cast<const BStorageType*>(p_b_grid),
            b_grid_desc_k0_n_k1.GetElementSpaceSize());
        ...
        auto a_block_buf = make_dynamic_buffer<AddressSpaceEnum::Lds>(
            static_cast<AStorageType*>(p_shared), a_block_desc_k0_m_k1.GetElementSpaceSize());
