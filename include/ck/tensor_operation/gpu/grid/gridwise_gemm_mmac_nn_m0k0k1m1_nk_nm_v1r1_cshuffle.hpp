...
#include "ck/tensor_operation/gpu/block/blockwise_gemm_mmac_nn_v1.hpp"
...
#include "ck/tensor_operation/gpu/block/thread_group_tensor_slice_transfer_v6r2_src1_broadcast.hpp"
...
template <typename GridwiseGemm,
          ...
          typename C0ShuffleGridDesc_N0_N1_N2_M0_M1_M2,
...
__launch_bounds__(MaxThreadPerBlock, MinBlockPerCU)
    ...
    kernel_gemm_mmac(
        ...
        const AGridDesc_B_M0_K0_K1_M1 a_grid_desc_b_m0_k0_k1_m1,
        const BGridDesc_B_N_K b_grid_desc_b_n_k,
        const CShuffleGridDesc_N0_N1_N2_M0_M1_M2 cshuffle_grid_desc_n0_n1_n2_m0_m1_m2,
        const C0ShuffleGridDesc_N0_N1_N2_M0_M1_M2 c0shuffle_grid_desc_n0_n1_n2_m0_m1_m2,
        ...
        const Block2CTileMap block_2_ctile_map)
{
    ...
    GridwiseGemm::template Run<HasMainKBlockLoop>(p_a_grid,
                                                  ...
                                                  p_c0_grid,
                                                  p_shared,
                                                  a_grid_desc_b_m0_k0_k1_m1,
                                                  b_grid_desc_b_n_k,
                                                  cshuffle_grid_desc_n0_n1_n2_m0_m1_m2,
                                                  c0shuffle_grid_desc_n0_n1_n2_m0_m1_m2,
                                                  a_element_op,
                                                  b_element_op,
                                                  c_element_op,
                                                  block_2_ctile_map);
    ...
    ignore = p_c_grid;
    ignore = p_c0_grid;
    ignore = a_grid_desc_b_m0_k0_k1_m1;
    ignore = b_grid_desc_b_n_k;
    ignore = cshuffle_grid_desc_n0_n1_n2_m0_m1_m2;
    ignore = c0shuffle_grid_desc_n0_n1_n2_m0_m1_m2;
    ignore = a_element_op;
    ignore = b_element_op;
    ignore = c_element_op;
...
struct GridwiseGemm_mmac_nn_m0k0k1m1_nk_nm_v1r1_cshuffle
{
    ...
    static_assert(NmmacRepeat == 1 && NmmacInterleave == 1 && MmmacRepeat == 1 &&
                  MmmacInterleave == 2 && CShuffleBlockTransferDstScalarPerVector == 4);
    ...
    static constexpr bool ALdsDirectLoad = true;
    ...
    GetABlockDescriptor_M0PerBlock_K0PerBlock_K1PerBlock_M1PerBlock()
    {

        return make_naive_tensor_descriptor_aligned(make_tuple(Number<M0PerBlock>{},
                                                               Number<K0PerBlock>{},
                                                               Number<K1PerBlock>{},
                                                               Number<M1PerBlock>{}),
                                                    Number<M1PerBlock>{});
    ...
    __host__ __device__ static constexpr auto GetBBlockDescriptor_NPerBlock_KPerBlock()
    {
        ...
        return make_naive_tensor_descriptor_aligned(
            make_tuple(Number<NPerBlock>{}, Number<KPerBlock>{}), Number<KPerBlock>{});
    }

    __host__ __device__ static constexpr auto
    GetABlockDescriptor_B_M0PerBlock_K0PerBlock_K1PerBlock_M1PerBlock()
    {

        return make_naive_tensor_descriptor_aligned(make_tuple(I1,
                                                               Number<M0PerBlock>{},
                                                               Number<K0PerBlock>{},
                                                               Number<K1PerBlock>{},
                                                               Number<M1PerBlock>{}),
    ...
    __host__ __device__ static constexpr auto GetBBlockDescriptor_B_NPerBlock_KPerBlock()
    {
        ...
        return make_naive_tensor_descriptor_aligned(
            make_tuple(I1, Number<NPerBlock>{}, Number<KPerBlock>{}), Number<KPerBlock>{});
    }
    ...
    __host__ __device__ static constexpr index_t GetSharedMemoryNumberOfByte()
    {
        ...
        constexpr auto a_block_space_size_aligned =
            math::integer_least_multiple(a_block_desc.GetElementSpaceSize(), Number<M1PerBlock>{});
    ...
    CheckValidity(const AGridDesc_B_M0_K0_K1_M1& a_grid_desc_b_m0_k0_k1_m1,
                  const BGridDesc_B_N_K& b_grid_desc_b_n_k,
                  ...
                  const Block2CTileMap& block_2_ctile_map)
    {
        ...
        const auto M =
            a_grid_desc_b_m0_k0_k1_m1.GetLength(I1) * a_grid_desc_b_m0_k0_k1_m1.GetLength(I4);
        const auto N  = b_grid_desc_b_n_k.GetLength(I1);
        const auto K0 = a_grid_desc_b_m0_k0_k1_m1.GetLength(I2);
    ...
    __host__ __device__ static constexpr auto
    MakeCShuffleGridDescriptor_N0_N1_N2_M0_M1_M2(const CGridDesc_M_N_& c_grid_desc_m_n)
    {
    ...
    using C0ShuffleGridDesc_N0_N1_N2_M0_M1_M2 =
        decltype(MakeCShuffleGridDescriptor_N0_N1_N2_M0_M1_M2(C0GridDesc_M_N{}));
    ...
    Run(const ADataType* __restrict__ p_a_grid,
        const BDataType* __restrict__ p_b_grid,
        CDataType* __restrict__ p_c_grid,
        const CDataType* __restrict__ p_c0_grid,
        ...
        const Block2CTileMap& block_2_ctile_map)
    {
        const auto a_grid_buf = make_dynamic_buffer<AddressSpaceEnum::Global>(
            ...
            a_grid_desc_b_m0_k0_k1_m1.GetElementSpaceSize());
        ...
        const auto c0_grid_buf = make_dynamic_buffer<AddressSpaceEnum::Global>(
            p_c0_grid, c0shuffle_grid_desc_n0_n1_n2_m0_m1_m2.GetElementSpaceSize());
        ...
        constexpr auto a_block_desc_m0_k0_k1_m1 =
            GetABlockDescriptor_M0PerBlock_K0PerBlock_K1PerBlock_M1PerBlock();

        constexpr auto a_block_desc_b_m0_k0_k1_m1 =
            GetABlockDescriptor_B_M0PerBlock_K0PerBlock_K1PerBlock_M1PerBlock();
        ...
        auto blockwise_gemm = BlockwiseGemmASmemBSmemCReg_mmac_nn_m0k0k1m1_nk_nm_v1<
            BlockSize,
            ADataType,
            BDataType,
            AccDataType,
            decltype(a_block_desc_m0_k0_k1_m1),
        ...
        auto a_blockwise_copy = ThreadGroupTensorSliceTransfer_DirectLoad<
            ThisThreadBlock,
            Sequence<1, M0PerBlock, K0PerBlock, K1PerBlock, M1PerBlock>,
            ABlockTransferThreadClusterLengths_B_M0_K0_K1_M1,
            ADataType,
            ADataType,
            decltype(a_grid_desc_b_m0_k0_k1_m1),
            decltype(a_block_desc_b_m0_k0_k1_m1),
            ABlockTransferSrcVectorDim,
            ABlockTransferSrcVectorDim,
            ABlockTransferSrcScalarPerVector,
            true>(a_grid_desc_b_m0_k0_k1_m1,
                  make_multi_index(k_batch_id, m_block_data_idx_on_grid / M1PerBlock, 0, 0, 0),
                  a_block_desc_b_m0_k0_k1_m1,
        ...
        constexpr auto a_block_slice_copy_step = make_multi_index(0, 0, K0PerBlock, 0, 0);
        ...
        // output: shuffle C and write out
        {
            ...
            // cshuffle lds -> global
            auto cshuffle_block_copy_lds_to_global =
                ThreadGroupTensorSliceTransfer_v6r2_src1_broadcast<
                    ...
                    Sequence<1,
                             ...
                             Mwaves * MmmacRepeat * MPerMmac *
                                 MmmacInterleave>, // BlockSliceLengths,
                    ...
                    decltype(c0shuffle_grid_desc_n0_n1_n2_m0_m1_m2),
            ...
            static_for<0,
                ...
                static_for<0,
                    ...
                    constexpr index_t m_wave_repeat_value =
                        m_wave_repeat_forward_sweep
                            ? m_wave_repeat_iter
                            : (MwaveRepeat - m_wave_repeat_iter - CShuffleMwaveRepeatPerShuffle);
                    ...
                    // LDS to global
                    cshuffle_block_copy_lds_to_global.Run(cshuffle_block_desc_n0_n1_n2_m0_m1_m2,
                                                          cshuffle_block_buf,
                                                          c0shuffle_grid_desc_n0_n1_n2_m0_m1_m2,
                                                          c0_grid_buf,
                                                          cshuffle_grid_desc_n0_n1_n2_m0_m1_m2,
                    ...
                    if constexpr(m_wave_repeat_forward_sweep &&
                                 (m_wave_repeat < MwaveRepeat - CShuffleMwaveRepeatPerShuffle))
                    {
                        cshuffle_block_copy_lds_to_global.MoveDstSliceWindow(
                            cshuffle_grid_desc_n0_n1_n2_m0_m1_m2, m_wave_repeat_forward_step);

                        cshuffle_block_copy_lds_to_global.MoveSrc1SliceWindow(
                            c0shuffle_grid_desc_n0_n1_n2_m0_m1_m2, m_wave_repeat_forward_step);
                    }
                    else if constexpr((!m_wave_repeat_forward_sweep) && (m_wave_repeat > 0))
                    {
                        cshuffle_block_copy_lds_to_global.MoveDstSliceWindow(
                            cshuffle_grid_desc_n0_n1_n2_m0_m1_m2, m_wave_repeat_backward_step);

                        cshuffle_block_copy_lds_to_global.MoveSrc1SliceWindow(
                            c0shuffle_grid_desc_n0_n1_n2_m0_m1_m2, m_wave_repeat_backward_step);
                    }
                });
                ...
                if constexpr(n_wave_repeat < NwaveRepeat - CShuffleNwaveRepeatPerShuffle)
                {
                    ...
                    cshuffle_block_copy_lds_to_global.MoveSrc1SliceWindow(
                        c0shuffle_grid_desc_n0_n1_n2_m0_m1_m2, n_wave_repeat_forward_step);
                }
            });
        }
    }
