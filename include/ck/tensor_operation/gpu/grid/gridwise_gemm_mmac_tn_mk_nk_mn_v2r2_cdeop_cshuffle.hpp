...
template <index_t WGSize,
          ...
          index_t occupancy>
struct GridwiseGemm_mmac_tn_mk_nk_mn_v2r2_cdeop_cshuffle
{
    ...
    using C1ShuffleGridDesc_M0_M1_M2_M3_N0_N1_N2 =
        decltype(MakeCShuffleGridDescriptor_M0_M1_M2_M3_N0_N1_N2(C1GridDesc_M_N{}));
    ...
    Run(const ADataType* __restrict__ p_a_grid,
        ...
        const C1ShuffleGridDesc_M0_M1_M2_M3_N0_N1_N2& c1shuffle_grid_desc_m0_m1_m2_m3_n0_n1_n2,
        ...
        const index_t b_const_stride = sizeof(BDataType))
    {
        ...
        const auto c1_grid_buf = make_dynamic_buffer<AddressSpaceEnum::Global>(
            p_c1_grid, c1shuffle_grid_desc_m0_m1_m2_m3_n0_n1_n2.GetElementSpaceSize());
        ...
        if(WG::IsWG0())
        {
            ...
            // output: shuffle C and write out
            {
                ...
                auto cshuffle_block_copy_lds_to_global = ThreadGroupTensorSliceTransfer_v6r3<
                    ...
                    decltype(c1shuffle_grid_desc_m0_m1_m2_m3_n0_n1_n2),
                    ...
                    {cshuffle_block_desc_m0_m1_m2_m3_n0_n1_n2,
                     ...
                     c1shuffle_grid_desc_m0_m1_m2_m3_n0_n1_n2,
                     make_multi_index(block_work_idx[I1], 0, 0, 0, block_work_idx[I2], 0, 0),
