...
struct MultiStageGemmPipeline_ConvRxS_v2
{
    template <bool v>
    ...
    template <bool HasMainKBlockLoop,
              ...
              typename std::enable_if<
                  ...
                  bool>::type = false>
    __device__ static void RunLowerWG(BlockwiseGemm blockwise_gemm,
    ...
    template <bool HasMainKBlockLoop,
              ...
              typename std::enable_if<
                  std::is_same_v<bool_constant<ALdsDirectLoad_>, bool_constant<false>> &&
                      std::is_same_v<bool_constant<BLdsDirectLoad_>, bool_constant<false>>,
                  bool>::type = false>
    __device__ static void RunUpperWG(BlockwiseGemm blockwise_gemm,
                                      const AGridDesc& a_grid_desc,
                                      const ABlockDesc& a_block_desc,
                                      ABlockTransfer& a_blockwise_copy,
                                      const AGridBuffer& a_grid_buf,
