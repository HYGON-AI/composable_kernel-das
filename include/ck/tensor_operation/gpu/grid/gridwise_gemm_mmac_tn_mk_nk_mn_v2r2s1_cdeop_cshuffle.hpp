...
#include "ck/tensor_operation/gpu/grid/multistage_gemm_pipeline_convRxS_v2r2s1.hpp"
...
template <index_t WGSize,
          ...
          index_t occupancy>
struct GridwiseGemm_mmac_tn_mk_nk_mn_v2r2s1_cdeop_cshuffle
{
    ...
    using MultiStageGemmPipeline =
        remove_cvref_t<decltype(MultiStageGemmPipeline_ConvRxS_v2r2s1<NumGemmKPrefetchStage,
                                                                      ALdsDirectLoad,
                                                                      BLdsDirectLoad>())>;
    ...
    __host__ __device__ static constexpr auto GetCShuffleBlockDescriptor_M0_M1_M2_N0_N1_N2_N3()
    {
        constexpr auto cshuffle_block_desc_m0_m1_m2_n0_n1_n2_n3 =
        ...
        return cshuffle_block_desc_m0_m1_m2_n0_n1_n2_n3;
    }

    template <typename CGridDesc_M_N_>
    __host__ __device__ static constexpr auto
    MakeCShuffleGridDescriptor_M0_M1_M2_N0_N1_N2_N3(const CGridDesc_M_N_& c_grid_desc_m_n)
    {
        ...
        const auto cshuffle_grid_desc_m0_m1_m2_n0_n1_n2_n3 = transform_tensor_descriptor(
            c_grid_desc_m_n,
            make_tuple(
        ...
        return cshuffle_grid_desc_m0_m1_m2_n0_n1_n2_n3;
    }
    ...
    __host__ __device__ static constexpr index_t GetSharedMemoryNumberOfByte()
    {
        ...
        constexpr auto cshuffle_block_desc_m0_m1_m2_n0_n1_n2_n3 =
            GetCShuffleBlockDescriptor_M0_M1_M2_N0_N1_N2_N3();

        constexpr auto cshuffle_block_space_size =
            cshuffle_block_desc_m0_m1_m2_n0_n1_n2_n3.GetElementSpaceSize();

        return math::max((a_block_space_size_aligned * sizeof(AStorageType) +
                          NumWG * b_block_space_size_aligned * sizeof(BStorageType)),
    ...
    {
        static_assert(
            (MPerBlock % (MwaveRepeat * MmmacRepeat * MPerMmac * MmmacInterleave) == 0) &&
                (NPerBlock % (NumWG * NwaveRepeat * NmmacRepeat * NPerMmac * NmmacInterleave)) == 0,
    ...
    using CShuffleGridDesc_M0_M1_M2_N0_N1_N2_N3 =
        decltype(MakeCShuffleGridDescriptor_M0_M1_M2_N0_N1_N2_N3(CGridDesc_M_N{}));
    using C0ShuffleGridDesc_M0_M1_M2_N0_N1_N2_N3 =
        decltype(MakeCShuffleGridDescriptor_M0_M1_M2_N0_N1_N2_N3(C0GridDesc_M_N{}));
    using C1ShuffleGridDesc_M0_M1_M2_N0_N1_N2_N3 =
        decltype(MakeCShuffleGridDescriptor_M0_M1_M2_N0_N1_N2_N3(C1GridDesc_M_N{}));
    ...
    Run(const ADataType* __restrict__ p_a_grid,
        ...
        const C1ShuffleGridDesc_M0_M1_M2_N0_N1_N2_N3& c1shuffle_grid_desc_m0_m1_m2_n0_n1_n2_n3,
        ...
        const index_t b_const_stride = sizeof(BDataType))
    {
        ...
        auto c_grid_buf = make_dynamic_buffer<AddressSpaceEnum::Global>(
            p_c_grid, cshuffle_grid_desc_m0_m1_m2_n0_n1_n2_n3.GetElementSpaceSize());

        const auto c0_grid_buf = make_dynamic_buffer<AddressSpaceEnum::Global>(
            p_c0_grid, c0shuffle_grid_desc_m0_m1_m2_n0_n1_n2_n3.GetElementSpaceSize());

        const auto c1_grid_buf = make_dynamic_buffer<AddressSpaceEnum::Global>(
            p_c1_grid, c1shuffle_grid_desc_m0_m1_m2_n0_n1_n2_n3.GetElementSpaceSize());
        ...
        if(!block_2_ctile_map.ValidCTileIndex(
               block_work_idx,
               make_tuple(cshuffle_grid_desc_m0_m1_m2_n0_n1_n2_n3.GetLength(I0),
                          cshuffle_grid_desc_m0_m1_m2_n0_n1_n2_n3.GetLength(I3))))
        {
            return;
        }
        ...
        constexpr auto b0_block_bufs_offset = a_block_space_size_aligned;
        auto b0_block_bufs =
        ...
        if(WG::IsWG0())
        {
            ...
            // output: shuffle C and write out
            {
                ...
                // M0: Mblocks, M1: MwaveRepeat, M2: MwavesPerWG * MmmacRepeat * MPerMmac *
                // MmmacInterleave N0: Nblocks, N1: NwaveRepeat, N2: Nwaves * NmmacRepeat * NPerMMac
                // * NmmacInterleave
                constexpr auto cshuffle_block_desc_m0_m1_m2_n0_n1_n2_n3 =
                    GetCShuffleBlockDescriptor_M0_M1_M2_N0_N1_N2_N3();
                ...
                constexpr auto cshuffle_block_desc_interleaved = transform_tensor_descriptor(
                    cshuffle_block_desc_m0_m1_m2_n0_n1_n2_n3,
                ...
                auto cshuffle_block_copy_lds_to_global = ThreadGroupTensorSliceTransfer_v6r3<
                    ...
                    decltype(cshuffle_block_desc_m0_m1_m2_n0_n1_n2_n3),
                    decltype(c0shuffle_grid_desc_m0_m1_m2_n0_n1_n2_n3),
                    decltype(c1shuffle_grid_desc_m0_m1_m2_n0_n1_n2_n3),
                    decltype(cshuffle_grid_desc_m0_m1_m2_n0_n1_n2_n3),
                    ...
                    {cshuffle_block_desc_m0_m1_m2_n0_n1_n2_n3,
                     ...
                     make_multi_index(block_work_idx[I1], 0, 0, block_work_idx[I2], 0, 0, 0),
                     c1shuffle_grid_desc_m0_m1_m2_n0_n1_n2_n3,
                     make_multi_index(block_work_idx[I1], 0, 0, block_work_idx[I2], 0, 0, 0),
                ...
                constexpr auto m_wave_repeat_forward_step =
                    make_multi_index(0, CShuffleMwaveRepeatPerShuffle, 0, 0, 0, 0, 0);
            ...
            // output: shuffle C and write out
            {
                ...
                auto cshuffle_block_copy_lds_to_global = ThreadGroupTensorSliceTransfer_v6r3<
                    ...
                    {cshuffle_block_desc_m0_m1_m2_n0_n1_n2_n3,
                     make_multi_index(0, 0, 0, 0, 0, 0, 0),
                     c0shuffle_grid_desc_m0_m1_m2_n0_n1_n2_n3,
                     make_multi_index(block_work_idx[I1], 0, 0, block_work_idx[I2], 1, 0, 0),
                     c1shuffle_grid_desc_m0_m1_m2_n0_n1_n2_n3,
                     make_multi_index(block_work_idx[I1], 0, 0, block_work_idx[I2], 1, 0, 0),
                     cshuffle_grid_desc_m0_m1_m2_n0_n1_n2_n3,
                     make_multi_index(block_work_idx[I1], 0, 0, block_work_idx[I2], 1, 0, 0),
