...
#include "ck/tensor_operation/gpu/grid/multistage_gemm_pipeline_convRxS_v2r3.hpp"
...
struct GridwiseGemm_mmac_tn_mk_nk_mn_v2r3_cdop_cshuffle
{
    ...
    static constexpr index_t SubFactor      = 2;
    static constexpr index_t MSubBlockPerWG = MPerWG / SubFactor;
    static constexpr index_t NSubBlock      = NPerBlock / SubFactor;
    ...
    using MultiStageGemmPipeline =
        remove_cvref_t<decltype(MultiStageGemmPipeline_ConvRxS_v2r3<NumGemmKPrefetchStage,
                                                                    ALdsDirectLoad,
                                                                    BLdsDirectLoad,
                                                                    loop_remainder>())>;
    ...
    __host__ __device__ static constexpr auto GetABlockDescriptor_MPerBlock_KPerBlock()
    {
        ...
        return make_naive_tensor_descriptor_packed(
            make_tuple(Number<MSubBlockPerWG>{}, Number<KPerBlock>{}));
    }
    ...
    __host__ __device__ static constexpr auto GetBBlockDescriptor_NPerBlock_KPerBlock()
    {
        ...
        return make_naive_tensor_descriptor_packed(
            make_tuple(Number<NSubBlock>{}, Number<KPerBlock>{}));
    }
    ...
    __host__ __device__ static constexpr auto GetABlockDescriptor_B_MPerBlock_KPerBlock()
    {
        ...
        return make_naive_tensor_descriptor_packed(
            make_tuple(I1, Number<MSubBlockPerWG>{}, Number<KPerBlock>{}));
    }
    ...
    __host__ __device__ static constexpr auto GetBBlockDescriptor_B_NPerBlock_KPerBlock()
    {
        ...
        return make_naive_tensor_descriptor_packed(
            make_tuple(I1, Number<NSubBlock>{}, Number<KPerBlock>{}));
    }
