...
#include "ck/tensor_operation/gpu/grid/multistage_gemm_pipeline_convRxS_v2r4.hpp"
...
template <index_t BlockSize,
          ...
          typename CShuffleBlockTransferClusterLengths_M0_M1_M2_M3_N0_N1_N2_N3,
...
struct GridwiseGemm_mmac_tn_mk_nk_mn_v2r4_cdop_cshuffle
{
    ...
    static constexpr index_t NwavesPerWG =
        NPerWG / (NwaveRepeat * NmmacRepeat * NPerMmac * NmmacInterleave);

    using WG = QuadWG<BlockSize>;

    // TODO: make it configurable?
    static constexpr index_t MWGs      = 2;
    static constexpr index_t NWGs      = 2;
    ...
    using MultiStageGemmPipeline =
        remove_cvref_t<decltype(MultiStageGemmPipeline_ConvRxS_v2r4<NumGemmKPrefetchStage,
                                                                    ALdsDirectLoad,
                                                                    BLdsDirectLoad>())>;
    ...
    __host__ __device__ static constexpr auto GetCShuffleBlockDescriptor_M0_M1_M2_M3_N0_N1_N2_N3()
    {
        constexpr auto cshuffle_block_desc_m0_m1_m2_m3_n0_n1_n2_n3 =
            make_naive_tensor_descriptor_packed(
                make_tuple(I1,
                           ...
                           Number<NwavesPerWG * NmmacRepeat * NPerMmac * NmmacInterleave>{}));

        return cshuffle_block_desc_m0_m1_m2_m3_n0_n1_n2_n3;
    }

    template <typename CGridDesc_M_N_>
    __host__ __device__ static constexpr auto
    MakeCShuffleGridDescriptor_M0_M1_M2_M3_N0_N1_N2_N3(const CGridDesc_M_N_& c_grid_desc_m_n)
    {
        ...
        const auto cshuffle_grid_desc_m0_m1_m2_m3_n0_n1_n2_n3 = transform_tensor_descriptor(
            c_grid_desc_m_n,
            make_tuple(make_unmerge_transform(
                       ...
                       make_unmerge_transform(
                           make_tuple(NBlocks,
                                      NWGs,
                                      NwaveRepeat,
                                      NwavesPerWG * NmmacRepeat * NPerMmac * NmmacInterleave))),
            make_tuple(Sequence<0>{}, Sequence<1>{}),
            make_tuple(Sequence<0, 1, 2, 3>{}, Sequence<4, 5, 6, 7>{}));

        return cshuffle_grid_desc_m0_m1_m2_m3_n0_n1_n2_n3;
    }
    ...
    __host__ __device__ static constexpr index_t GetSharedMemoryNumberOfByte()
    {
        ...
        constexpr auto cshuffle_block_desc_m0_m1_m2_m3_n0_n1_n2_n3 =
            GetCShuffleBlockDescriptor_M0_M1_M2_M3_N0_N1_N2_N3();

        constexpr auto cshuffle_block_space_size =
            cshuffle_block_desc_m0_m1_m2_m3_n0_n1_n2_n3.GetElementSpaceSize();

        return math::max((MWGs * a_block_space_size_aligned * sizeof(AStorageType) +
                          NWGs * b_block_space_size_aligned * sizeof(BStorageType)),
                         MWGs * NWGs * cshuffle_block_space_size * sizeof(CDataType));
    }
    ...
    {
        static_assert(
            (MPerBlock % (MWGs * MwaveRepeat * MmmacRepeat * MPerMmac * MmmacInterleave) == 0) &&
                (NPerBlock % (NWGs * NwaveRepeat * NmmacRepeat * NPerMmac * NmmacInterleave)) == 0,
    ...
    using CShuffleGridDesc_M0_M1_M2_M3_N0_N1_N2_N3 =
        decltype(MakeCShuffleGridDescriptor_M0_M1_M2_M3_N0_N1_N2_N3(CGridDesc_M_N{}));
    using C0ShuffleGridDesc_M0_M1_M2_M3_N0_N1_N2_N3 =
        decltype(MakeCShuffleGridDescriptor_M0_M1_M2_M3_N0_N1_N2_N3(C0GridDesc_M_N{}));
    ...
    Run(const ADataType* __restrict__ p_a_grid,
        ...
        const BGridDesc_B_N_K& b_grid_desc_b_n_k,
        const CShuffleGridDesc_M0_M1_M2_M3_N0_N1_N2_N3& cshuffle_grid_desc_m0_m1_m2_m3_n0_n1_n2_n3,
        const C0ShuffleGridDesc_M0_M1_M2_M3_N0_N1_N2_N3&
            c0shuffle_grid_desc_m0_m1_m2_m3_n0_n1_n2_n3,
        ...
        const index_t b_const_stride = sizeof(BDataType))
    {
        ...
        auto c_grid_buf = make_dynamic_buffer<AddressSpaceEnum::Global>(
            p_c_grid, cshuffle_grid_desc_m0_m1_m2_m3_n0_n1_n2_n3.GetElementSpaceSize());

        const auto c0_grid_buf = make_dynamic_buffer<AddressSpaceEnum::Global>(
            p_c0_grid, c0shuffle_grid_desc_m0_m1_m2_m3_n0_n1_n2_n3.GetElementSpaceSize());
        ...
        if(!block_2_ctile_map.ValidCTileIndex(
               block_work_idx,
               make_tuple(cshuffle_grid_desc_m0_m1_m2_m3_n0_n1_n2_n3.GetLength(I0),
                          cshuffle_grid_desc_m0_m1_m2_m3_n0_n1_n2_n3.GetLength(I4))))
        {
            return;
        }
        ...
        constexpr auto b_block_space_size_aligned = math::integer_least_multiple(
            b_block_desc_n_k.GetElementSpaceSize(), Number<KPerBlock>{});
        ...
        constexpr auto b0_block_bufs_offset = a_block_space_size_aligned * MWGs;
        auto b0_block_bufs =
            ck::lds_utils::AllocateLdsBuffers<BDataType, 1>(p_shared,
                                                            b_block_desc_n_k.GetElementSpaceSize(),
                                                            b0_block_bufs_offset,
                                                            Number<KPerBlock>{});

        constexpr auto b1_block_bufs_offset =
            a_block_space_size_aligned * MWGs + b_block_space_size_aligned;
        auto b1_block_bufs =
            ck::lds_utils::AllocateLdsBuffers<BDataType, 1>(p_shared,
                                                            b_block_desc_n_k.GetElementSpaceSize(),
                                                            b1_block_bufs_offset,
                                                            Number<KPerBlock>{});
        ...
        if(WG::IsWG0())
        {
            ...
            // output: shuffle C and write out
            {
                ...
                // N0: Nblocks
                // N1: NwaveRepeat
                // N2: NwavesPerWG * NmmacRepeat * NPerMMac * NmmacInterleave
                constexpr auto cshuffle_block_desc_m0_m1_m2_m3_n0_n1_n2_n3 =
                    GetCShuffleBlockDescriptor_M0_M1_M2_M3_N0_N1_N2_N3();
                ...
                constexpr auto cshuffle_block_desc_interleaved = transform_tensor_descriptor(
                    cshuffle_block_desc_m0_m1_m2_m3_n0_n1_n2_n3,
                ...
                auto cshuffle_block_copy_lds_to_global = ThreadGroupTensorSliceTransfer_v6r2<
                    ...
                    Sequence<I1,
                             ...
                             I1,
                             CShuffleNwaveRepeatPerShuffle,
                             NwavesPerWG * NmmacRepeat * NPerMmac *
                                 NmmacInterleave>, // BlockSliceLengths,
                    CShuffleBlockTransferClusterLengths_M0_M1_M2_M3_N0_N1_N2_N3,
                    Sequence<0, 1, 2, 3, 4, 5, 6, 7>, // typename ThreadClusterArrangeOrder,
                    CDataType,                        // typename Src0Data,
                    C0DataType,                       // typename Src1Data
                    CDataType,                        // typename DstData,
                    decltype(cshuffle_block_desc_m0_m1_m2_m3_n0_n1_n2_n3),
                    decltype(c0shuffle_grid_desc_m0_m1_m2_m3_n0_n1_n2_n3),
                    decltype(cshuffle_grid_desc_m0_m1_m2_m3_n0_n1_n2_n3),
                    Sequence<0, 1, 2, 3, 4, 5, 6, 7>,        // typename DimAccessOrder,
                    7,                                       // index_t VectorDim,
                    ...
                    {cshuffle_block_desc_m0_m1_m2_m3_n0_n1_n2_n3,
                     make_multi_index(0, 0, 0, 0, 0, 0, 0, 0),
                     c0shuffle_grid_desc_m0_m1_m2_m3_n0_n1_n2_n3,
                     make_multi_index(block_work_idx[I1], 0, 0, 0, block_work_idx[I2], 0, 0, 0),
                     cshuffle_grid_desc_m0_m1_m2_m3_n0_n1_n2_n3,
                     make_multi_index(block_work_idx[I1], 0, 0, 0, block_work_idx[I2], 0, 0, 0),
                     c_element_op};

                constexpr auto m_wave_repeat_forward_step =
                    make_multi_index(0, 0, CShuffleMwaveRepeatPerShuffle, 0, 0, 0, 0, 0);
                constexpr auto n_wave_repeat_forward_step =
                    make_multi_index(0, 0, 0, 0, 0, 0, CShuffleNwaveRepeatPerShuffle, 0);
        ...
        else if(WG::IsWG1())
        {
            ...
            auto b_blockwise_copy = ThreadGroupTensorSliceTransfer_LdsSwizzle_ConvFwdFilter_v2<
                ...
                false,
                b_cache_swizzle>(b_grid_desc_b_n_k,
                                 make_multi_index(k_batch_id, n_block_data_idx_on_grid + NPerWG, 0),
                                 b_block_desc_b_n_k,
                                 make_multi_index(0, 0, 0),
                                 b_offset_delta_c,
                                 b_offset_delta_r,
            ...
            // output: shuffle C and write out
            {
                ...
                auto cshuffle_block_copy_lds_to_global = ThreadGroupTensorSliceTransfer_v6r2<
                    ...
                    {cshuffle_block_desc_m0_m1_m2_m3_n0_n1_n2_n3,
                     make_multi_index(0, 0, 0, 0, 0, 0, 0, 0),
                     c0shuffle_grid_desc_m0_m1_m2_m3_n0_n1_n2_n3,
                     make_multi_index(block_work_idx[I1], 1, 0, 0, block_work_idx[I2], 1, 0, 0),
                     cshuffle_grid_desc_m0_m1_m2_m3_n0_n1_n2_n3,
                     make_multi_index(block_work_idx[I1], 1, 0, 0, block_work_idx[I2], 1, 0, 0),
                     c_element_op};
        ...
        else if(WG::IsWG2())
        {
            ...
            MultiStageGemmPipeline::template RunWG23<HasMainKBlockLoop>(
                blockwise_gemm, a0_block_bufs, b1_block_bufs, c_thread_buf, num_k_block_main_loop);
            ...
            // output: shuffle C and write out
            {
                ...
                auto cshuffle_block_buf = make_dynamic_buffer<AddressSpaceEnum::Lds>(
                    static_cast<CDataType*>(p_shared) +
                        cshuffle_block_desc_m0_m1_m2_m3_n0_n1_n2_n3.GetElementSpaceSize() * 2,
                    cshuffle_block_desc_m0_m1_m2_m3_n0_n1_n2_n3.GetElementSpaceSize());
                ...
                auto cshuffle_block_copy_lds_to_global = ThreadGroupTensorSliceTransfer_v6r2<
                    ...
                    {cshuffle_block_desc_m0_m1_m2_m3_n0_n1_n2_n3,
                     make_multi_index(0, 0, 0, 0, 0, 0, 0, 0),
                     c0shuffle_grid_desc_m0_m1_m2_m3_n0_n1_n2_n3,
                     make_multi_index(block_work_idx[I1], 0, 0, 0, block_work_idx[I2], 1, 0, 0),
                     cshuffle_grid_desc_m0_m1_m2_m3_n0_n1_n2_n3,
                     make_multi_index(block_work_idx[I1], 0, 0, 0, block_work_idx[I2], 1, 0, 0),
                     c_element_op};
        ...
        else
        {
            ...
            MultiStageGemmPipeline::template RunWG23<HasMainKBlockLoop>(
                blockwise_gemm, a1_block_bufs, b0_block_bufs, c_thread_buf, num_k_block_main_loop);
            ...
            // output: shuffle C and write out
            {
                ...
                auto cshuffle_block_buf = make_dynamic_buffer<AddressSpaceEnum::Lds>(
                    static_cast<CDataType*>(p_shared) +
                        cshuffle_block_desc_m0_m1_m2_m3_n0_n1_n2_n3.GetElementSpaceSize() * 3,
                    cshuffle_block_desc_m0_m1_m2_m3_n0_n1_n2_n3.GetElementSpaceSize());
                ...
                auto cshuffle_block_copy_lds_to_global = ThreadGroupTensorSliceTransfer_v6r2<
                    ...
                    {cshuffle_block_desc_m0_m1_m2_m3_n0_n1_n2_n3,
                     make_multi_index(0, 0, 0, 0, 0, 0, 0, 0),
                     c0shuffle_grid_desc_m0_m1_m2_m3_n0_n1_n2_n3,
                     make_multi_index(block_work_idx[I1], 1, 0, 0, block_work_idx[I2], 0, 0, 0),
                     cshuffle_grid_desc_m0_m1_m2_m3_n0_n1_n2_n3,
                     make_multi_index(block_work_idx[I1], 1, 0, 0, block_work_idx[I2], 0, 0, 0),
                     c_element_op};
