...
#include "ck/tensor_operation/gpu/block/blockwise_gemm_mmac_skip_b_lds.hpp"
...
template <typename GridwiseGemm,
          ...
          typename CGridDesc_M0_N0_M1_N1_M2_N2_N3_N4,
...
#endif
    kernel_gemm_mmac_skip_b_lds_v1(
        const ADataType* __restrict__ p_a_grid,
        const BDataType* __restrict__ p_b_grid,
        CDataType* __restrict__ p_c_grid,
        const AGridDesc_K0_M_K1 a_grid_desc_k0_m_k1,
        const BGridDesc_K0_K1_K2_N0_N1_N2_N3_K3 b_grid_desc_k0_k1_k2_n0_n1_n2_n3_k3,
        const CGridDesc_M0_N0_M1_N1_M2_N2_N3_N4 c_grid_desc_m0_n0_m1_n1_m2_n2_n3_n4,
...
struct GridwiseGemm_k0mk1_k0nk1_mn_mmac_skip_b_lds_v1
{
    ...
    static constexpr index_t MWaves   = MPerBlock / (MMmacPerWave * MPerMmac);
    static constexpr index_t NWaves   = NPerBlock / (NMmacPerWave * NPerMmac);

    static constexpr index_t KPerBlock = K0PerBlock * K1Value;

    static constexpr auto mmac_gemm =
        MmacGemm<ADataType, BDataType, MPerMmac, NPerMmac, KPerBlock, K1>{};
                  ...
                  index_t N01)
    {
        ...
        static_assert((MPerBlock % (MPerMmac * MMmacPerWave) == 0) &&
    ...
    MakeBGridDescriptor_K0_K1_K2_N0_N1_N2_N3_K3(const BGridDesc_K0_N_K1& b_grid_desc_k0_n_k1)
    {
        ...
        const auto b_griddesc_k0_nblockid_nrepeat_waves_npermmac_k1 = transform_tensor_descriptor(
            b_grid_desc_k0_n_k1,
            make_tuple(make_unmerge_transform(
                           make_tuple(K0 / K0PerBlock, mmac_gemm.K0PerMmac, K0PerThread)),
                       make_unmerge_transform(make_tuple(
                           N / (NMmacPerWave * NWaves * NPerMmac), NMmacPerWave, NWaves, NPerMmac)),
                       make_pass_through_transform(K1)),
            make_tuple(Sequence<0>{}, Sequence<1>{}, Sequence<2>{}),
            make_tuple(Sequence<0, 1, 2>{}, Sequence<3, 4, 5, 6>{}, Sequence<7>{}));
        return b_griddesc_k0_nblockid_nrepeat_waves_npermmac_k1;
    }
    ...
    __device__ static auto GetWaveKNIdx(const index_t thread_id)
    {
        constexpr auto wave_threadid_to_nk_idx_adaptor = make_single_stage_tensor_adaptor(
            make_tuple(make_merge_transform(make_tuple(mmac_gemm.K0PerMmac, NPerMmac))),
    ...
    MakeCGridDescriptor_M0_N0_M1_N1_M2_N2_N3_N4(const CGridDesc_M_N& c_grid_desc_m_n)
    {
        ...
        constexpr auto b_thread_desc_k0_k1_k2_n0_n1_n2_n3_k3 =
            make_naive_tensor_descriptor_packed(make_tuple(I1,
                                                           ...
                                                           I1,                     // NBlockId
                                                           Number<NMmacPerWave>{}, // repeat
                                                           I1,                     // waves
                                                           I1,                     // NPerXdlops
                                                           Number<K1>{}));

        using BlockwiseGemm = BlockwiseGemmMmac_k0mk1_k0nk1_m0n0m1n1m2n2n3n4_v1r1<
            BlockSize,
            ADataType,
            BDataType,
            AccDataType,
    ...
    using CGridDesc_M0_N0_M1_N1_M2_N2_N3_N4 =
        decltype(MakeCGridDescriptor_M0_N0_M1_N1_M2_N2_N3_N4(CGridDesc_M_N{}));
        ...
        const Block2CTileMap& block_2_ctile_map)
    {
        ...
        printf("mfma thread k per xdlops: %d K0PerThread: %d HasMainK0BlockLoop: %d K0: %d  \t", 
                mmac_gemm.K0PerMmac, K0PerThread, HasMainK0BlockLoop, b_grid_desc_k0_k1_k2_n0_n1_n2_n3_k3.GetLength(I0));
#endif
        ...
        //       register
        // sanity check
        auto blockwise_gemm = BlockwiseGemmMmac_k0mk1_k0nk1_m0n0m1n1m2n2n3n4_v1r1<
            BlockSize,
            ADataType,
            BDataType,
            AccDataType,
        ...
        auto a_block_buf = make_dynamic_buffer<AddressSpaceEnum::Lds>(
            static_cast<ADataType*>(p_shared), a_block_desc_k0_m_k1.GetElementSpaceSize());
