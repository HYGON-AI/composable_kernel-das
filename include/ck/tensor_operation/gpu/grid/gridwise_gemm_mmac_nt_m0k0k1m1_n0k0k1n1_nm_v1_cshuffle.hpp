...
struct GridwiseGemm_mmac_nt_m0k0k1m1_n0k0k1n1_nm_v1_cshuffle
{
    ...
    static_assert(NmmacRepeat == 2 && NmmacInterleave == 1 && MmmacRepeat == 1 &&
...
#if CK_SUPPORT_EXTENDED_BUFFER_LOAD_LDS_DIRECT
    static constexpr index_t ALdsDirectLoad = true;
    static constexpr index_t BLdsDirectLoad = true;
#else
    static constexpr index_t ALdsDirectLoad = false;
    static constexpr index_t BLdsDirectLoad = false;
#endif
    ...
    using BlockwiseGemm = BlockwiseGemmASmemBSmemCReg_mmac_nt_m0k0k1m1_n0k0k1n1_mn_v1<
        ...
        BDataType,
        AccDataType,
        decltype(GetABlockDescriptor_M0PerBlock_K0PerBlock_K1PerBlock_M1PerBlock()),
    ...
    {
        return BlockwiseGemm<true>::MakeCGridDescriptorInterleaved12D(c_grid_desc_m_n);
    }
        ...
        const Block2CTileMap& block_2_ctile_map)
    {
...
#else
        // A matrix blockwise copy
        auto a_blockwise_copy = ThreadGroupTensorSliceTransfer_Generic<
            ThisThreadBlock,
            Sequence<1, M0PerBlock, K0PerBlock, K1PerBlock, M1PerBlock>,
            ABlockTransferThreadClusterLengths_B_M0_K0_K1_M1,
            ADataType,
        ...
        // output: register to global memory
        {
            // output: shuffle C and write out
            {
                ...
                // M0: Mblocks, M1: MwaveRepeat, M2: Mwaves * MmmacRepeat * MPerMmac *
                    ...
                    [&](auto n_wave_repeat_iter) {
                        ...
                        static_for<0, MwaveRepeat, CShuffleMwaveRepeatPerShuffle>{}(
                            [&](auto m_wave_repeat_iter) {
                                ...
                                else if constexpr((!m_wave_repeat_forward_sweep) &&
                                                  (m_wave_repeat > 0))
                                {
                                    cshuffle_block_copy_lds_to_global.MoveDstSliceWindow(
                                        cshuffle_grid_desc_n0_n1_n2_m0_m1_m2,
