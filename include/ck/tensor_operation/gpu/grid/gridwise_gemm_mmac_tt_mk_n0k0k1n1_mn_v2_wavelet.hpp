...
struct GridwiseGemm_mmac_tt_mk_n0k0k1n1_mn_v2_wavelet
{
                               ...
                               const Block2CTileMap& block_2_ctile_map)
    {
        ...
        if(WaveletTG::IsLoadGroup())
        {
            ...
            MultiStagePipeline::template RunLoadPipeline<HasMainK0BlockLoop>(
                a_grid_desc_b_m_k,
                a_block_desc_b_m_k,
                a_blockwise_copy,
                a_grid_buf,
        ...
        {
            auto blockwise_gemm = BlockwiseGemmASmemBSmemCReg_mmac_tt_mk_n0k0k1n1_mn_v2<
                TileMathThreadGroupSize,
                ADataType,
                BDataType,
                AccDataType,
            ...
            MultiStagePipeline::template RunMathPipeline<HasMainK0BlockLoop>(
