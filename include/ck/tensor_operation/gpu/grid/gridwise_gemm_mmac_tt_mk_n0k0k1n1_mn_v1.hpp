...
#include "ck/tensor_operation/gpu/block/blockwise_gemm_mmac_tt_v1.hpp"
...
struct GridwiseGemm_mmac_tt_mk_n0k0k1n1_mn_v1
{
    ...
    MakeCGridDescriptorInterleaved12D(const CGridDesc_M_N& c_grid_desc_m_n)
    {
        ...
        using BlockwiseGemm = BlockwiseGemmASmemBSmemCReg_mmac_tt_mk_n0k0k1n1_mn_v1<
            BlockSize,
            ADataType,
            BDataType,
            AccDataType,
                               ...
                               const Block2CTileMap& block_2_ctile_map)
    {
        ...
        auto blockwise_gemm = BlockwiseGemmASmemBSmemCReg_mmac_tt_mk_n0k0k1n1_mn_v1<
            BlockSize,
            ADataType,
            BDataType,
            AccDataType,
