...
{
    GridwiseWelfordSecondHalfReduceFirstHalf_::Run(x_grid_desc_k0_m_k100_k10_k11,
...
struct GridwiseWelfordSecondHalfReduceFirstHalf_opt
{
    static_assert((XDyVectorDim == 4 && KThreadSliceSize % XSrcVectorSize == 0 &&
                               ...
                               DscaleDbiasDataType* const __restrict__ p_reduce_dbias)
    {
        ...
        const auto thread_k1_cluster_id = thread_cluster_idx[I4];
        ...
        else
        {
            ...
            if(block_local_id == 0 && thread_k1_cluster_id == 0)
            {
        ...
        auto threadwise_x_load =
            ThreadwiseTensorSliceTransfer_v2<XDataType,
                ...
                make_multi_index(block_local_id,
                                 ...
                                 0,
                                 0,
                                 thread_k1_cluster_id * XSrcVectorSize));
        ...
        auto threadwise_dy_load =
            ThreadwiseTensorSliceTransfer_v2<DyDataType,
                ...
                make_multi_index(block_local_id,
                                 ...
                                 0,
                                 0,
                                 thread_k1_cluster_id * DySrcVectorSize));
            ...
            static_for<0, K10, 1>{}([&](auto iK10) {
                static_for<0, MThreadSliceSize, 1>{}([&](auto iM) {
                    ...
                    static_for<0, KThreadSliceSize, 1>{}([&](auto iK) {
                        ...
                        tmp1_thread_buf(Number<offset>{}) =
                            norm_x * dy_thread_buf[Number<offset>{}];
                    });
