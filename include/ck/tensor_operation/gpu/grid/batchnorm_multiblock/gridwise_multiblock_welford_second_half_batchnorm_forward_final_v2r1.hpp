...
#endif
    __global__ void kernel_welford_second_half_batchnorm_forward_final_opt(
        const XYGridDesc_K0_M_K100_K10_K11 x_grid_desc_k0_m_k100_k10_k11,
        const XYGridDesc_K0_M_K100_K10_K11 y_grid_desc_k0_m_k100_k10_k11,
...
{
    GridwiseWelfordSecondHalfBatchNormForwardFinal_::Run(x_grid_desc_k0_m_k100_k10_k11,
                                                         y_grid_desc_k0_m_k100_k10_k11,
...
struct GridwiseWelfordSecondHalfBatchNormForwardFinal_opt
{
    static_assert((XSrcYDstVectorDim == 4 && KThreadSliceSize % XSrcVectorSize == 0),
                  "Invalid thread slice sizes and/or vector sizes configuration, please check!");

    static_assert((XSrcYDstVectorDim == 4 && KThreadSliceSize % YDstVectorSize == 0),
                  "Invalid thread slice sizes and/or vector sizes configuration, please check!");
...

    {
        ...
        auto y_global_val_buf = make_dynamic_buffer<AddressSpaceEnum::Global>(
            p_y, y_grid_desc_k0_m_k100_k10_k11.GetElementSpaceSize());
        ...
        for(index_t workTiles = 0; workTiles < num_xy_k_block_tile_iteration; ++workTiles)
        {
            ...
            static_for<0, K10, 1>{}([&](auto iK10) {
                static_for<0, MThreadSliceSize, 1>{}([&](auto iM) {
                    ...
                    threadwise_y_store.Run(thread_buffer_desc_k0_m_k100_k10_k11,
                                           make_tuple(I0, iM, I0, iK10, I0),
                                           y_thread_buf,
                                           y_grid_desc_k0_m_k100_k10_k11,
                                           y_global_val_buf);
                    ...
                    threadwise_y_store.MoveDstSliceWindow(y_grid_desc_k0_m_k100_k10_k11,
                                                          xy_thread_copy_step_m);
                });
                threadwise_x_load.MoveSrcSliceWindow(x_grid_desc_k0_m_k100_k10_k11,
