...
// weight tensor
// packed KGCX/KGCYX/KGCZYX
struct KGCX : public BaseTensorLayout
{
    static constexpr const char* name = "KGCX";
};

struct KGCYX : public BaseTensorLayout
{
    static constexpr const char* name = "KGCYX";
};

struct KGCZYX : public BaseTensorLayout
{
    static constexpr const char* name = "KGCZYX";
};
...
// add NGCHWcBase
struct NGCHWcBase : public BaseTensorLayout
{
};

// add NGCHWc
template <int x_>
struct NGCHWc : public NGCHWcBase
{
    static constexpr int x            = x_;
    static constexpr const char* name = "NGCHWc";
};

// add NGKHWk
template <int x_>
struct NGKHWk : public NGCHWcBase
{
    static constexpr int x            = x_;
    static constexpr const char* name = "NGKHWk";
};

// add GKCYXcBase
struct GKCYXcBase : public BaseTensorLayout
{
};

// add GKCYXc
template <int x_>
struct GKCYXc : public GKCYXcBase
{
    static constexpr int x            = x_;
    static constexpr const char* name = "GKCYXc";
};

// Hack: define NGCHWc32/GKCYXc32/NGKHWk32 here
using NGCHWc32 = NGCHWc<32>;
using GKCYXc32 = GKCYXc<32>;
using NGKHWk32 = NGKHWk<32>;
