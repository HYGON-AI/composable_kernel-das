...
#include "ck/tensor_operation/gpu/grid/gridwise_gemm_mmac_tn_mk_nk_nm_v2r1_cshuffle.hpp"
...
struct DeviceGroupedConvFwdBiasActivation_mmac_v2_cshuffle_mixed
...
{
    using DeviceOp = DeviceGroupedConvFwdBiasActivation_mmac_v2_cshuffle_mixed;
    ...
    using GridwiseGemm = GridwiseGemm_mmac_tn_mk_nk_nm_v2r1_cshuffle<
        BlockSize,
        ADataType,
        BDataType,
        AccDataType,
        ...
        float Run(const Argument& arg, const StreamConfig& stream_config = StreamConfig{})
        {
                                            ...
                                            arg.block_2_ctile_map_))
            {
                throw std::runtime_error(
                    "wrong! GridwiseGemm_mmac_tn_mk_nk_mn_v2r1 has invalid setting");
            }
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "DeviceGroupedConvFwdBiasActivation_mmac_v2_cshuffle_mixed"
            << "-"
            << BlockSize << "-"
            << MPerBlock << "-"
            << NPerBlock << "-"
