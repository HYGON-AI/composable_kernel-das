...
#include "ck/tensor_operation/gpu/grid/gridwise_gemm_mmac_tn_mk_nk_mn_v1.hpp"
...
struct DeviceGemm_mmac_tn_mk_nk_mn_v1 : public DeviceGemm<ck::tensor_layout::gemm::RowMajor,
                                                          ...
                                                          CElementwiseOperation>
{
    ...
    using GridwiseGemm = GridwiseGemm_mmac_tn_mk_nk_mn_v1<BlockSize,
                                                          ADataType,
                                                          BDataType,
                                                          AccDataType,
                                                          CDataType,
    ...
    struct Argument : public BaseArgument
    {
        ...
        {
            a_grid_desc_b_m_k_ =
                DeviceGemm_mmac_tn_mk_nk_mn_v1::MakeAGridDescriptor_B_M_K(M, K, KSplit_);
            b_grid_desc_b_n_k_ =
                DeviceGemm_mmac_tn_mk_nk_mn_v1::MakeBGridDescriptor_B_N_K(N, K, KSplit_);
            c_grid_desc_m_n_ = DeviceGemm_mmac_tn_mk_nk_mn_v1::MakeCGridDescriptor_M_N(M, N);
    ...
    {
        using Argument = DeviceGemm_mmac_tn_mk_nk_mn_v1::Argument;
        ...
        float Run(const Argument& arg, const StreamConfig& stream_config = StreamConfig{})
        {
            ...
            if(GridwiseGemm::CalculateHasMainKBlockLoop(K))
            {
                const auto kernel = kernel_gemm_mmac<
                    ...
                    BDataType,
                    CDataType,
                    remove_reference_t<DeviceGemm_mmac_tn_mk_nk_mn_v1::AGridDesc_B_M_K>,
                    remove_reference_t<DeviceGemm_mmac_tn_mk_nk_mn_v1::BGridDesc_B_N_K>,
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "DeviceGemm_mmac_tn_mk_nk_mn_v1"
            << "-"
            << BlockSize << "-"
            << MPerBlock << "-"
            << NPerBlock << "-"
