...
#include "ck/tensor_operation/gpu/grid/gridwise_gemm_mmac_tn_mk_nk_mn_v2r1_cdop_cshuffle.hpp"
...
struct DeviceGroupedConvFwdBiasActivation_mmac_v2r1_cshuffle
...
{
    using DeviceOp = DeviceGroupedConvFwdBiasActivation_mmac_v2r1_cshuffle;
    ...
    // FIXME: we don't want padding here, since we only consider spatial oob in underlying
    // implementations, however, changing GemmSpecialization::MNPadding to
    // GemmSpecialization::Default will cause vgpr spill, so we do no-padding check in
    // IsSupportArgument() instead
    static constexpr auto matrix_padder =
        MatrixPadder<GemmSpecialization::MNPadding, ck::index_t, ck::index_t, ck::index_t>{
            MPerBlock, NPerBlock, KPerBlock};

    static constexpr bool a_oob_check =
        ConvForwardSpecialization == ConvolutionForwardSpecialization::Filter3x3 ? true : false;
    static constexpr bool b_oob_check = false;
    ...
    using GridwiseGemm = GridwiseGemm_mmac_tn_mk_nk_mn_v2r1_cdop_cshuffle<
        BlockSize,
        ADataType,
        BDataType,
        AccDataType,
    ...
    struct Argument : public BaseArgument
    {
        ...
        Argument(const void* p_a,
            ...
            : p_a_grid_(static_cast<const ADataType*>(p_a)),
              ...
              cshuffle_grid_desc_m0_m1_m2_n0_n1_n2_(),
              c0shuffle_grid_desc_m0_m1_m2_n0_n1_n2_(),
              block_2_ctile_map_(),
              ...
              input_right_pads_{input_right_pads}
        {
            ...
            // H, W, delta_h, delta_w
            H_       = a_g_n_c_wis_lengths[3];
            W_       = a_g_n_c_wis_lengths[4];
            delta_h_ = DilationH;
            delta_w_ = DilationW;
            ...
            {
                cshuffle_grid_desc_m0_m1_m2_n0_n1_n2_ =
                    GridwiseGemm::MakeCShuffleGridDescriptor_M0_M1_M2_N0_N1_N2(c_grid_desc_m_n_);

                c0shuffle_grid_desc_m0_m1_m2_n0_n1_n2_ =
                    GridwiseGemm::MakeCShuffleGridDescriptor_M0_M1_M2_N0_N1_N2(c0_grid_desc_m_n_);
            }
        }
        ...
        void Print() const
        {
            ...
            std::cout << "C: " << cshuffle_grid_desc_m0_m1_m2_n0_n1_n2_ << std::endl;
        }
        ...
        typename GridwiseGemm::CShuffleGridDesc_M0_M1_M2_N0_N1_N2
            cshuffle_grid_desc_m0_m1_m2_n0_n1_n2_;
        typename GridwiseGemm::C0ShuffleGridDesc_M0_M1_M2_N0_N1_N2
            c0shuffle_grid_desc_m0_m1_m2_n0_n1_n2_;
        ...
        float Run(const Argument& arg, const StreamConfig& stream_config = StreamConfig{})
        {
            ...
            auto launch_kernel = [&](auto has_main_k_block_loop_) {
                ...
                const auto kernel = kernel_grouped_conv_fwd_mmac_v2<
                    ...
                    remove_reference_t<typename GridwiseGemm::CShuffleGridDesc_M0_M1_M2_N0_N1_N2>,
                    remove_reference_t<typename GridwiseGemm::C0ShuffleGridDesc_M0_M1_M2_N0_N1_N2>,
                    AElementwiseOperation,
                    BElementwiseOperation,
                    CElementwiseOperation,
                ...
                return launch_and_time_kernel(stream_config,
                                              ...
                                              arg.b_grid_desc_b_n_k_,
                                              arg.cshuffle_grid_desc_m0_m1_m2_n0_n1_n2_,
                                              arg.c0shuffle_grid_desc_m0_m1_m2_n0_n1_n2_,
                                              arg.a_element_op_,
                                              arg.b_element_op_,
                                              arg.c_element_op_,
                                              arg.num_group_,
    ...
    static bool IsSupportedArgument(const Argument& arg)
    {
        ...
        if constexpr(MPerBlock * NPerBlock > 128 * 128)
        {
            return false;
        }
        ...
        // TODO: support mnk padding in underlying implementations
        if((arg.c_g_n_k_wos_lengths_[1] * arg.c_g_n_k_wos_lengths_[3] *
            arg.c_g_n_k_wos_lengths_[4] % MPerBlock) != 0)
        {
            return false;
        }
        else if(arg.c_g_n_k_wos_lengths_[2] % NPerBlock != 0)
        {
            return false;
        }
        else if(arg.b_g_k_c_xs_lengths_[2] % KPerBlock != 0)
        {
            return false;
        }
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "DeviceGroupedConvFwdBiasActivation_mmac_v2r1_cshuffle"
            << "-"
            << BlockSize << "-"
            << MPerBlock << "-"
            << NPerBlock << "-"
