...
#include "ck/tensor_operation/gpu/grid/gridwise_gemm_mmac_tn_mk_nk_mn_v2r2s1_cdop_cshuffle.hpp"
...
struct DeviceGroupedConvFwdBiasActivation_mmac_v2r2s1_cshuffle
...
{
    using DeviceOp = DeviceGroupedConvFwdBiasActivation_mmac_v2r2s1_cshuffle;
    ...
    using GridwiseGemm = GridwiseGemm_mmac_tn_mk_nk_mn_v2r2s1_cdop_cshuffle<
        WGSize,
        ADataType,
        BDataType,
        AccDataType,
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "DeviceGroupedConvFwdBiasActivation_mmac_v2r2s1_cshuffle"
            << "-"
            << BlockSize << "-"
            << MPerBlock << "-"
            << NPerBlock << "-"
