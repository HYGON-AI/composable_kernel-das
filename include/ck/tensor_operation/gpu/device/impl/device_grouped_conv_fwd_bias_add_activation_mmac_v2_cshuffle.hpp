...
#include "ck/tensor_operation/gpu/grid/gridwise_gemm_mmac_tn_mk_nk_mn_v2_cdeop_cshuffle.hpp"
...
struct DeviceGroupedConvFwdBiasAddActivation_mmac_v2_cshuffle
...
{
    using DeviceOp = DeviceGroupedConvFwdBiasAddActivation_mmac_v2_cshuffle;
    ...
    using GridwiseGemm = GridwiseGemm_mmac_tn_mk_nk_mn_v2_cdeop_cshuffle<
        BlockSize,
        ADataType,
        BDataType,
        AccDataType,
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "DeviceGroupedConvFwdBiasAddActivation_mmac_v2_cshuffle"
            << "-"
            << BlockSize << "-"
            << MPerBlock << "-"
            << NPerBlock << "-"
