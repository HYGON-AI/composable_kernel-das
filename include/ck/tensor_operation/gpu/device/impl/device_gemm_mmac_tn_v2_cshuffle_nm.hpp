...
#include "ck/tensor_operation/gpu/grid/gridwise_gemm_mmac_tn_mk_nk_nm_v2_cshuffle.hpp"
...
struct DeviceGemm_mmac_tn_mk_nk_nm_v2_cshuffle
                        ...
                        CElementwiseOperation>
{
    ...
    struct Argument : public BaseArgument
    {
        ...
        {
            a_grid_desc_b_m_k_ =
                DeviceGemm_mmac_tn_mk_nk_nm_v2_cshuffle::MakeAGridDescriptor_B_M_K(M, K, KSplit_);
            b_grid_desc_b_n_k_ =
                DeviceGemm_mmac_tn_mk_nk_nm_v2_cshuffle::MakeBGridDescriptor_B_N_K(N, K, KSplit_);
            c_grid_desc_m_n_ =
                DeviceGemm_mmac_tn_mk_nk_nm_v2_cshuffle::MakeCGridDescriptor_M_N(M, N);
    ...
    {
        using Argument = DeviceGemm_mmac_tn_mk_nk_nm_v2_cshuffle::Argument;
        ...
        float Run(const Argument& arg, const StreamConfig& stream_config = StreamConfig{})
        {
            ...
            if(GridwiseGemm::CalculateHasMainKBlockLoop(K))
            {
                const auto kernel = kernel_gemm_mmac<
                    ...
                    BDataType,
                    CDataType,
                    remove_reference_t<DeviceGemm_mmac_tn_mk_nk_nm_v2_cshuffle::AGridDesc_B_M_K>,
                    remove_reference_t<DeviceGemm_mmac_tn_mk_nk_nm_v2_cshuffle::BGridDesc_B_N_K>,
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "DeviceGemm_mmac_tn_mk_nk_nm_v2_cshuffle"
            << "-"
            << BlockSize << "-"
            << MPerBlock << "-"
            << NPerBlock << "-"
