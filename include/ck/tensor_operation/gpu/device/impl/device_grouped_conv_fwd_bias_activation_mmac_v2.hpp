...
struct DeviceGroupedConvFwdBiasActivation_mmac_v2
...
{
    using DeviceOp = DeviceGroupedConvFwdBiasActivation_mmac_v2;
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "DeviceGroupedConvFwdBiasActivation_mmac_v2"
            << "-"
            << BlockSize << "-"
            << MPerBlock << "-"
            << NPerBlock << "-"
