...
#include "ck/tensor_operation/gpu/grid/gridwise_gemm_mmac_nn_m0k0k1m1_nk_nm_v1r1_cshuffle.hpp"
...
__global__ void __launch_bounds__(MaxThreadPerBlock, MinBlockPerCU)
    kernel_grouped_conv_fwd_mmac_nchw_v2_cshuffle(
        const ADataType* __restrict__ p_a_grid,
        const BDataType* __restrict__ p_b_grid,
        CDataType* __restrict__ p_c_grid,
        const C0DataType* __restrict__ p_c0_grid,
        const AGridDesc_B_M0_K0_K1_M1 a_grid_desc_m0_k0_k1_m1,
        ...
        const ComputePtrOffsetOfBatch compute_ptr_offset_of_batch)
{
    ...
    ignore = p_c_grid;
    ignore = p_c0_grid;
    ignore = a_grid_desc_m0_k0_k1_m1;
...
struct DeviceGroupedConvFwdBiasActivation_mmac_nchw_v2_cshuffle
...
{
    using DeviceOp = DeviceGroupedConvFwdBiasActivation_mmac_nchw_v2_cshuffle;
    ...
    static constexpr auto MPerBlock = M0PerBlock * M1PerBlock;
    static constexpr auto KPerBlock = K0PerBlock * K1PerBlock;
    ...
    using GridwiseGemm = GridwiseGemm_mmac_nn_m0k0k1m1_nk_nm_v1r1_cshuffle<
        BlockSize,
        ADataType,
        BDataType,
        AccDataType,
    ...
    struct Argument : public BaseArgument
    {
        ...
        Argument(const void* p_a,
            ...
            : p_a_grid_(static_cast<const ADataType*>(p_a)),
              ...
              a_grid_desc_b_m0_k0_k1_m1_(MakeAGridDescriptor_B_M0_K0_K1_M1(a_g_n_c_wis_lengths,
                                                                           a_g_n_c_wis_strides,
                                                                           b_g_k_c_xs_lengths,
                                                                           b_g_k_c_xs_strides,
                                                                           c_g_n_k_wos_lengths,
              ...
              c0shuffle_grid_desc_n0_n1_n2_m0_m1_m2_(),
              block_2_ctile_map_(),
              ...
              input_right_pads_{input_right_pads}
        {
                                           ...
                                           block_2_ctile_map_))
            {
                ...
                c0shuffle_grid_desc_n0_n1_n2_m0_m1_m2_ =
                    GridwiseGemm::MakeCShuffleGridDescriptor_N0_N1_N2_M0_M1_M2(c0_grid_desc_m_n_);
            }
        }

        void Print() const
        {
            std::cout << "A[M, K]: " << a_grid_desc_b_m0_k0_k1_m1_ << std::endl;
        ...
        typename GridwiseGemm::CShuffleGridDesc_N0_N1_N2_M0_M1_M2
            cshuffle_grid_desc_n0_n1_n2_m0_m1_m2_;
        typename GridwiseGemm::C0ShuffleGridDesc_N0_N1_N2_M0_M1_M2
            c0shuffle_grid_desc_n0_n1_n2_m0_m1_m2_;
        ...
        float Run(const Argument& arg, const StreamConfig& stream_config = StreamConfig{})
        {
                                            ...
                                            arg.block_2_ctile_map_))
            {
                throw std::runtime_error(
                    "wrong! GridwiseGemm_mmac_nn_m0k0k1m1_nk_nm_v1r1_cshuffle has invalid setting");
            }
            ...
            auto launch_kernel = [&](auto has_main_k_block_loop_) {
                ...
                const auto kernel = kernel_grouped_conv_fwd_mmac_nchw_v2_cshuffle<
                    GridwiseGemm,
                    ADataType,
                    BDataType,
                    CDataType,
                    ...
                    remove_reference_t<typename GridwiseGemm::C0ShuffleGridDesc_N0_N1_N2_M0_M1_M2>,
                    AElementwiseOperation,
                    BElementwiseOperation,
                    CElementwiseOperation,
                ...
                return launch_and_time_kernel(stream_config,
                                              ...
                                              arg.c0shuffle_grid_desc_n0_n1_n2_m0_m1_m2_,
                                              arg.a_element_op_,
                                              arg.b_element_op_,
                                              arg.c_element_op_,
                                              arg.num_group_,
    ...
    static bool IsSupportedArgument(const Argument& arg)
    {
        ...
        if constexpr(is_same_v<ALayout, ctc::NGCHW>)
        {
            const ck::index_t HoWo = arg.c_g_n_k_wos_lengths_[3] * arg.c_g_n_k_wos_lengths_[4];

            if(!(ABlockTransferSrcVectorDim == 4 && HoWo % ABlockTransferSrcScalarPerVector == 0))
            {
                return false;
            }
        }
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "DeviceGroupedConvFwdBiasActivation_mmac_nchw_v2_cshuffle"
            << "-"
            << BlockSize << "-"
            << M0PerBlock << "-"
            << M1PerBlock << "-"
