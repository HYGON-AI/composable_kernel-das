...
struct DeviceGroupedConvFwd_mmac_v2 : public DeviceGroupedConvFwd<NDimSpatial,
                                                                  ALayout,
                                                                  BLayout,
                                                                  CLayout,
                                                                  ADataType,
...
{
    using DeviceOp = DeviceGroupedConvFwd_mmac_v2;
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "DeviceGroupedConvFwd_mmac_v2"
            << "-"
            << BlockSize << "-"
            << MPerBlock << "-"
            << NPerBlock << "-"
