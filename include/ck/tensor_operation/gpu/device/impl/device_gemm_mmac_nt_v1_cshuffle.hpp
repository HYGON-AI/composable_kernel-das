...
struct DeviceGemm_mmac_nt_m0k0k1m1_n0k0k1n1_nm_v1_cshuffle
                        ...
                        CElementwiseOperation>
{
    ...
    struct Argument : public BaseArgument
    {
        Argument(const ADataType* p_a_grid,
            ...
            : p_a_grid_{p_a_grid},
              ...
              KSplit_(1)
        {
            a_grid_desc_b_m0_k0_k1_m1_ = DeviceGemm_mmac_nt_m0k0k1m1_n0k0k1n1_nm_v1_cshuffle::
                MakeAGridDescriptor_B_M0_K0_K1_M1(M, K, KSplit_);
            b_grid_desc_b_n0_k0_k1_n1_ = DeviceGemm_mmac_nt_m0k0k1m1_n0k0k1n1_nm_v1_cshuffle::
                MakeBGridDescriptor_B_N0_K0_K1_N1(N, K, KSplit_);
            c_grid_desc_m_n_ =
                DeviceGemm_mmac_nt_m0k0k1m1_n0k0k1n1_nm_v1_cshuffle::MakeCGridDescriptor_M_N(M, N);
    ...
    {
        using Argument = DeviceGemm_mmac_nt_m0k0k1m1_n0k0k1n1_nm_v1_cshuffle::Argument;
        ...
        float Run(const Argument& arg, const StreamConfig& stream_config = StreamConfig{})
        {
            ...
            if(GridwiseGemm::CalculateHasMainKBlockLoop(K))
            {
                const auto kernel = kernel_gemm_mmac<
                    ...
                    BDataType,
                    CDataType,
                    remove_reference_t<DeviceGemm_mmac_nt_m0k0k1m1_n0k0k1n1_nm_v1_cshuffle::
                                           AGridDesc_B_M0_K0_K1_M1>,
                    remove_reference_t<DeviceGemm_mmac_nt_m0k0k1m1_n0k0k1n1_nm_v1_cshuffle::
                                           BGridDesc_B_N0_K0_K1_N1>,
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "DeviceGemm_mmac_nt_m0k0k1m1_n0k0k1n1_nm_v1_cshuffle"
            << "-"
            << BlockSize << "-"
            << M0PerBlock << "-"
            << M1PerBlock << "-"
