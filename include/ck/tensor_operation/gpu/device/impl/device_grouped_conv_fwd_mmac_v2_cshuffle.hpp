...
#include "ck/tensor_operation/gpu/grid/gridwise_gemm_mmac_tn_mk_nk_mn_v2_cshuffle.hpp"
...
struct DeviceGroupedConvFwd_mmac_v2_cshuffle : public DeviceGroupedConvFwd<NDimSpatial,
                                                                           ALayout,
                                                                           BLayout,
                                                                           CLayout,
                                                                           ADataType,
...
{
    using DeviceOp = DeviceGroupedConvFwd_mmac_v2_cshuffle;
    ...
    using GridwiseGemm = GridwiseGemm_mmac_tn_mk_nk_mn_v2_cshuffle<
        BlockSize,
        ADataType,
        BDataType,
        AccDataType,
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "DeviceGroupedConvFwd_mmac_v2_cshuffle"
            << "-"
            << BlockSize << "-"
            << MPerBlock << "-"
            << NPerBlock << "-"
