...
#include "ck/tensor_operation/gpu/grid/gridwise_gemm_mmac_tn_mk_nk_mn_v2_wavelet.hpp"
...
struct DeviceGroupedConvFwd_mmac_v2_wavelet : public DeviceGroupedConvFwd<NDimSpatial,
                                                                          ALayout,
                                                                          BLayout,
                                                                          CLayout,
                                                                          ADataType,
...
{
    using DeviceOp = DeviceGroupedConvFwd_mmac_v2_wavelet;
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "DeviceGroupedConvFwd_mmac_v2_wavelet"
            << "-"
            << BlockSize << "-"
            << MPerBlock << "-"
            << NPerBlock << "-"
