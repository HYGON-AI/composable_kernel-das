...
#include "ck/tensor_operation/operator_transform/transform_conv_bwd_data_to_gemm_v2r1.hpp"
#include "ck/tensor_operation/gpu/device/gemm_specialization.hpp"
#include "ck/tensor_operation/gpu/device/matrix_padder.hpp"
#include "ck/tensor_operation/gpu/grid/gridwise_gemm_mmac_tt_mk_n0k0k1n1_mn_v2_cshuffle.hpp"
...
#endif
    kernel_grouped_conv_bwd_data_mmac_v2(
        ...
        const ComputePtrOffsetOfBatch compute_ptr_offset_of_batch)
{
     ...
     defined(__gfx936__) || defined(__gfx938__) || defined(__gfx946__))
    ...
    ignore = compute_ptr_offset_of_batch;
       ...
       // defined(__gfx938__) || defined(__gfx946__))
}
...
struct DeviceGroupedConvBwdData_mmac_v2_cshuffle
...
{
    using DeviceOp = DeviceGroupedConvBwdData_mmac_v2_cshuffle;
    ...
    static constexpr auto conv_to_gemm_transformer =
        TransformConvBwdDataToGemm_v2r1<NDimSpatial, ConvBwdDataSpecialization>{};
    ...
    static auto
    MakeAGridDescriptor_B_M_K(const std::array<ck::index_t, NDimSpatial + 3>& out_g_n_k_wos_lengths,
                              ...
                              const std::array<ck::index_t, NDimSpatial>& tildes)
    {
        const auto in_gemmmraw_gemmkraw_desc =
            conv_to_gemm_transformer.template MakeADescriptor_M_K<ALayout>(out_g_n_k_wos_lengths,
        ...
        const std::array<ck::index_t, NDimSpatial>& tildes)
    {
        const auto wei_gemmnraw_gemmkraw_desc =
            conv_to_gemm_transformer.template MakeBDescriptor_N_K<BLayout>(out_g_n_k_wos_lengths,
                                                                           out_g_n_k_wos_strides,
                                                                           wei_g_k_c_xs_lengths,
                                                                           wei_g_k_c_xs_strides,
                                                                           in_g_n_c_wis_lengths,
        ...
        const auto wei_b_gemmn0_gemmk0_gemmk1_gemmn1_desc = transform_tensor_descriptor(
            wei_gemmn_gemmk_desc,
            make_tuple(make_unmerge_transform(make_tuple(gemm_n / N1PerBlock, N1PerBlock)),
                       make_unmerge_transform(make_tuple(1, gemm_k / K1PerBlock, K1PerBlock))),
            make_tuple(Sequence<0>{}, Sequence<1>{}),
            make_tuple(Sequence<1, 4>{}, Sequence<0, 2, 3>{}));

        return wei_b_gemmn0_gemmk0_gemmk1_gemmn1_desc;
    }
                            ...
                            const std::array<ck::index_t, NDimSpatial>& tildes)
    {
        const auto out_gemmmraw_gemmnraw_desc =
            conv_to_gemm_transformer.template MakeCDescriptor_M_N<CLayout>(out_g_n_k_wos_lengths,
                                                                           out_g_n_k_wos_strides,
                                                                           wei_g_k_c_xs_lengths,
                                                                           wei_g_k_c_xs_strides,
                                                                           in_g_n_c_wis_lengths,
    ...
    using GridwiseGemm = GridwiseGemm_mmac_tt_mk_n0k0k1n1_mn_v2_cshuffle<
        BlockSize,
        ADataType,
        BDataType,
        AccDataType,
    ...
    struct Argument : public BaseArgument
    {
        Argument(const void* p_a,
            ...
            : p_a_grid_(static_cast<const ADataType*>(p_a)),
              ...
              a_grid_desc_b_m_k_container_(),
              b_grid_desc_b_n0_k0_k1_n1_container_(),
              c_grid_desc_m_n_container_(),
              cshuffle_grid_desc_m0_m1_m2_n0_n1_n2_container_(),
              ...
              input_right_pads_{input_right_pads}
        {
            ...
            if constexpr(NDimSpatial == 2)
            {
                ...
                for(ck::index_t i_ytilde = 0; i_ytilde < YTilde; ++i_ytilde)
                {
                    for(ck::index_t i_xtilde = 0; i_xtilde < XTilde; ++i_xtilde)
                    {
                        ...
                        // Gemm A (dout)
                        const auto a_grid_desc_b_m_k =
                            MakeAGridDescriptor_B_M_K(a_g_n_k_wos_lengths,
                                                      a_g_n_k_wos_strides,
                                                      b_g_k_c_xs_lengths,
                                                      b_g_k_c_xs_strides,
                                                      c_g_n_c_wis_lengths,
                        ...
                        // Gemm B (weight)
                        const auto b_grid_desc_b_n0_k0_k1_n1 =
                            MakeBGridDescriptor_B_N0_K0_K1_N1(a_g_n_k_wos_lengths,
                                                              a_g_n_k_wos_strides,
                                                              b_g_k_c_xs_lengths,
                                                              b_g_k_c_xs_strides,
                                                              c_g_n_c_wis_lengths,
                        ...
                        // Gemm C (dinput)
                        const auto c_grid_desc_m_n = MakeCGridDescriptor_M_N(a_g_n_k_wos_lengths,
                                                                             a_g_n_k_wos_strides,
                                                                             b_g_k_c_xs_lengths,
                                                                             b_g_k_c_xs_strides,
                                                                             c_g_n_c_wis_lengths,
                        ...
                        a_grid_desc_b_m_k_container_.push_back(a_grid_desc_b_m_k);
                        b_grid_desc_b_n0_k0_k1_n1_container_.push_back(b_grid_desc_b_n0_k0_k1_n1);
                        c_grid_desc_m_n_container_.push_back(c_grid_desc_m_n);

                        auto block_2_ctile_map =
                            GridwiseGemm::MakeDefaultBlock2CTileMap(c_grid_desc_m_n, M01, N01, 1);
                        block_2_ctile_map_container_.push_back(block_2_ctile_map);

                        if(GridwiseGemm::CheckValidity(a_grid_desc_b_m_k,
                                                       b_grid_desc_b_n0_k0_k1_n1,
                                                       c_grid_desc_m_n,
                                                       block_2_ctile_map))
                        {
                            cshuffle_grid_desc_m0_m1_m2_n0_n1_n2_container_.push_back(
                                GridwiseGemm::MakeCShuffleGridDescriptor_M0_M1_M2_N0_N1_N2(
                                    c_grid_desc_m_n));
                        }
                    }
                }
            ...
            {
                // problem definition
                const ck::index_t Z = b_g_k_c_xs_lengths[3];
                const ck::index_t Y = b_g_k_c_xs_lengths[4];
                const ck::index_t X = b_g_k_c_xs_lengths[5];

                const ck::index_t ConvStrideD = conv_filter_strides_[0];
                const ck::index_t ConvStrideH = conv_filter_strides_[1];
                const ck::index_t ConvStrideW = conv_filter_strides_[2];

                const ck::index_t ConvDilationD = conv_filter_dilations_[0];
                const ck::index_t ConvDilationH = conv_filter_dilations_[1];
                const ck::index_t ConvDilationW = conv_filter_dilations_[2];
                ...
                // number of GEMM
                num_gemm_ = ZTilde * YTilde * XTilde;

                for(ck::index_t i_ztilde = 0; i_ztilde < ZTilde; ++i_ztilde)
                {
                    for(ck::index_t i_ytilde = 0; i_ytilde < YTilde; ++i_ytilde)
                    {
                        for(ck::index_t i_xtilde = 0; i_xtilde < XTilde; ++i_xtilde)
                        {
                            ...
                            const auto c_grid_desc_m_n =
                                MakeCGridDescriptor_M_N(a_g_n_k_wos_lengths,
                                                        a_g_n_k_wos_strides,
                                                        b_g_k_c_xs_lengths,
                                                        b_g_k_c_xs_strides,
                                                        c_g_n_c_wis_lengths,
                            ...
                            a_grid_desc_b_m_k_container_.push_back(a_grid_desc_b_m_k);
                            b_grid_desc_b_n0_k0_k1_n1_container_.push_back(
                                b_grid_desc_b_n0_k0_k1_n1);
                            c_grid_desc_m_n_container_.push_back(c_grid_desc_m_n);

                            auto block_2_ctile_map = GridwiseGemm::MakeDefaultBlock2CTileMap(
                                c_grid_desc_m_n, M01, N01, 1);
                            block_2_ctile_map_container_.push_back(block_2_ctile_map);
            ...
            {
                static_assert(false, "Unsupported spatial dim");
            }
        }
        ...
        void Print() const
        {
            ...
            {
                const auto a_grid_desc_k0_m_k1 = a_grid_desc_b_m_k_container_[i];
                const auto b_grid_desc_k0_n_k1 = b_grid_desc_b_n0_k0_k1_n1_container_[i];
                const auto c_grid_desc_m_n     = c_grid_desc_m_n_container_[i];
                const auto cshuffle_grid_desc_m0_m1_m2_n0_n1_n2 =
                    cshuffle_grid_desc_m0_m1_m2_n0_n1_n2_container_[i];

                std::cout << "Gemm: " << i << std::endl;
                std::cout << "A[B, M, K]: " << a_grid_desc_k0_m_k1 << std::endl;
                std::cout << "B[B, N0, K0, K1, N1]: " << b_grid_desc_k0_n_k1 << std::endl;
                std::cout << "C[M, N]: " << c_grid_desc_m_n << std::endl;
                std::cout << "CShuffle: " << cshuffle_grid_desc_m0_m1_m2_n0_n1_n2 << std::endl;
            }
        }
        ...
        std::vector<AGridDesc_B_M_K> a_grid_desc_b_m_k_container_;
        std::vector<BGridDesc_B_N0_K0_K1_N1> b_grid_desc_b_n0_k0_k1_n1_container_;
        std::vector<CGridDesc_M_N> c_grid_desc_m_n_container_;
        std::vector<typename GridwiseGemm::CShuffleGridDesc_M0_M1_M2_N0_N1_N2>
            cshuffle_grid_desc_m0_m1_m2_n0_n1_n2_container_;
    ...
    struct Invoker : public BaseInvoker
    {
        ...
        float Run(const Argument& arg, const StreamConfig& stream_config = StreamConfig{})
        {
            ...
            {
                if(!GridwiseGemm::CheckValidity(arg.a_grid_desc_b_m_k_container_[i],
                                                arg.b_grid_desc_b_n0_k0_k1_n1_container_[i],
                                                arg.c_grid_desc_m_n_container_[i],
                                                arg.block_2_ctile_map_container_[i]))
                {
                    throw std::runtime_error(
                        "wrong! GridwiseGemm_mmac_tt_mk_n0k0k1n1_mn_v2 has invalid setting");
                }
                ...
                const auto K = arg.a_grid_desc_b_m_k_container_[i].GetLength(I2);
                ...
                auto launch_kernel = [&](auto has_main_k_block_loop_) {
                    ...
                    const auto kernel = kernel_grouped_conv_bwd_data_mmac_v2<
                        GridwiseGemm,
                        ADataType,
                        BDataType,
                        CDataType,
                        remove_reference_t<DeviceOp::AGridDesc_B_M_K>,
                        remove_reference_t<DeviceOp::BGridDesc_B_N0_K0_K1_N1>,
                        remove_reference_t<
                            typename GridwiseGemm::CShuffleGridDesc_M0_M1_M2_N0_N1_N2>,
                        AElementwiseOperation,
                        BElementwiseOperation,
                        CElementwiseOperation,
                    ...
                    return launch_and_time_kernel(
                        ...
                        arg.p_b_grid_,
                        arg.p_c_grid_,
                        arg.a_grid_desc_b_m_k_container_[i],
                        arg.b_grid_desc_b_n0_k0_k1_n1_container_[i],
                        arg.cshuffle_grid_desc_m0_m1_m2_n0_n1_n2_container_[i],
                        arg.a_element_op_,
                        arg.b_element_op_,
                        arg.c_element_op_,
                        arg.num_group_,
    ...
    static bool IsSupportedArgument(const Argument& arg)
    {
        ...
        else if constexpr(ConvBwdDataSpecialization ==
                          ConvolutionBackwardDataSpecialization::Default)
        {
            // hack: ignore f1x1s1p0 conv for default instances
        ...
        // Gemm A (doutput)
        if constexpr(is_same_v<ALayout, ctc::NHWGK> || is_same_v<ALayout, ctc::NDHWGK>)
        {
        ...
        // Gemm B (weight)
        if constexpr(is_same_v<BLayout, ctc::GKYXC> || is_same_v<BLayout, ctc::GKZYXC>)
        {
            // vector load along gemm n (ConvC)
            if(!(BBlockTransferSrcVectorDim == 4 && ConvC % BBlockTransferSrcScalarPerVector == 0))
            {
                return false;
            }
        }
        ...
        {
            // vector load along gemm n (ConvC)
            if constexpr(!(BBlockTransferSrcVectorDim == 4 &&
        ...
        // Gemm C (dinput)
        if constexpr(is_same_v<CLayout, ctc::NHWGC> || is_same_v<CLayout, ctc::NDHWGC>)
        {

            // vector store along gemm n (ConvC)
            if(!(ConvC % CShuffleBlockTransferDstScalarPerVector == 0))
            {
                return false;
            }
        }
        ...
        {
            // vector store along gemm n (ConvC)
            if constexpr(!(32 % CShuffleBlockTransferDstScalarPerVector == 0))
            {
                return false;
            }
        }
        else if constexpr(std::is_base_of_v<ck::tensor_layout::convolution::NGCHWcBase, CLayout>)
        {
            // vector store along gemm n (ConvC)
            if constexpr(!(CLayout::x % CShuffleBlockTransferDstScalarPerVector == 0))
            {
                return false;
            }
        }
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "DeviceGroupedConvBwdData_mmac_v2_cshuffle"
            << "-"
            << BlockSize << "-"
            << MPerBlock << "-"
            << N0PerBlock << "-"
