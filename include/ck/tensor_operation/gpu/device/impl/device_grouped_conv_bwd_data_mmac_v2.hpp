...
#include "ck/tensor_operation/gpu/grid/gridwise_gemm_mmac_tt_mk_n0k0k1n1_mn_v2.hpp"
...
struct DeviceGroupedConvBwdData_mmac_v2 : public DeviceGroupedConvBwdData<NDimSpatial,
                                                                          ALayout,
                                                                          BLayout,
                                                                          CLayout,
                                                                          ADataType,
...
{
    using DeviceOp = DeviceGroupedConvBwdData_mmac_v2;
    ...
    using GridwiseGemm =
        GridwiseGemm_mmac_tt_mk_n0k0k1n1_mn_v2<BlockSize,
                                               ADataType,
                                               BDataType,
                                               AccDataType,
                                               CDataType,
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "DeviceGroupedConvBwdData_mmac_v2"
            << "-"
            << BlockSize << "-"
            << MPerBlock << "-"
            << N0PerBlock << "-"
