...
struct DeviceGroupedConvFwd_mmac_nchw_v2_cshuffle
...
{
    using DeviceOp = DeviceGroupedConvFwd_mmac_nchw_v2_cshuffle;
        ...
        float Run(const Argument& arg, const StreamConfig& stream_config = StreamConfig{})
        {
                                            ...
                                            arg.block_2_ctile_map_))
            {
                throw std::runtime_error(
                    "wrong! GridwiseGemm_mmac_nn_m0k0k1m1_nk_nm_v1_cshuffle has invalid setting");
            }
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "DeviceGroupedConvFwd_mmac_nchw_v2_cshuffle"
            << "-"
            << BlockSize << "-"
            << M0PerBlock << "-"
            << M1PerBlock << "-"
