            ...
            const Block2ETileMap block_2_etile_map)
{
    ...
    defined(__gfx940__) || defined(__gfx936__))
                                        ...
                                        ComputeDataType>
{
    ...
    {
        if(!ck::is_xdl_mmac_supported<ComputeDataType, ComputeDataType, MPerXDL, NPerXDL>())
        {
            return false;
        }

        if(ck::get_device_name() != "gfx936" && std::is_same<ADataType, double>::value)
        {
            return false;
        }
