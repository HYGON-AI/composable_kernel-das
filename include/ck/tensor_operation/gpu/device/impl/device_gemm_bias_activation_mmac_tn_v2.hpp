...
#include "ck/tensor_operation/gpu/grid/gridwise_gemm_mmac_tn_mk_nk_mn_v2r1.hpp"
...
struct DeviceGemmBiasActivation_mmac_tn_mk_nk_mn_v2
                                      ...
                                      CElementwiseOperation>
{
    ...
    using GridwiseGemm =
        GridwiseGemm_mmac_tn_mk_nk_mn_v2r1<BlockSize,
                                           ADataType,
                                           BDataType,
                                           AccDataType,
                                           CDataType,
    ...
    struct Argument : public BaseArgument
    {
        ...
        {
            a_grid_desc_b_m_k_ =
                DeviceGemmBiasActivation_mmac_tn_mk_nk_mn_v2::MakeAGridDescriptor_B_M_K(
                    M, K, KSplit_);
            b_grid_desc_b_n_k_ =
                DeviceGemmBiasActivation_mmac_tn_mk_nk_mn_v2::MakeBGridDescriptor_B_N_K(
                    N, K, KSplit_);
            c_grid_desc_m_n_ =
                DeviceGemmBiasActivation_mmac_tn_mk_nk_mn_v2::MakeCGridDescriptor_M_N(M, N);
            d_grid_desc_m_n_ =
                DeviceGemmBiasActivation_mmac_tn_mk_nk_mn_v2::MakeC0GridDescriptor_M_N(M, N);
    ...
    {
        using Argument = DeviceGemmBiasActivation_mmac_tn_mk_nk_mn_v2::Argument;
        ...
        float Run(const Argument& arg, const StreamConfig& stream_config = StreamConfig{})
        {
            ...
            if(GridwiseGemm::CalculateHasMainKBlockLoop(K))
            {
                const auto kernel = kernel_gemm_mmac<
                    ...
                    C0DataType,
                    remove_reference_t<
                        DeviceGemmBiasActivation_mmac_tn_mk_nk_mn_v2::AGridDesc_B_M_K>,
                    remove_reference_t<
                        DeviceGemmBiasActivation_mmac_tn_mk_nk_mn_v2::BGridDesc_B_N_K>,
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "DeviceGemmBiasActivation_mmac_tn_mk_nk_mn_v2"
            << "-"
            << BlockSize << "-"
            << MPerBlock << "-"
            << NPerBlock << "-"
