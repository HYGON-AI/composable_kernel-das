...
struct CKTileConvWaspKernelV1_Wrapper : public DeviceGroupedConvFwd<NDimSpatial,
                                                                    InLayout_,
                                                                    WeiLayout_,
                                                                    OutLayout_,
                                                                    InDataType_,
                                                                    ...
                                                                    OutElementOp_>
{
    using DeviceOp = CKTileConvWaspKernelV1_Wrapper;
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "CKTileConvWaspKernelV1_Wrapper"
            << "-"
            << BlockSize << "-"
            << MWGs << "-"
            << NWGs << "-"
