...
struct CKTileConvWaspKernelV2R1_Wrapper : public DeviceGroupedConvFwd<NDimSpatial,
                                                                      InLayout_,
                                                                      WeiLayout_,
                                                                      OutLayout_,
                                                                      InDataType_,
                                                                      ...
                                                                      OutElementOp_>
{
    using DeviceOp = CKTileConvWaspKernelV2R1_Wrapper;
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "CKTileConvWaspKernelV2R1_Wrapper"
            << "-"
            << BlockSize << "-"
            << MWGs << "-"
            << NWGs << "-"
