...
struct FusedConvMlsWaspPersistantKernelV1_CBA_Wrapper
    : public DeviceGroupedConvFwdBiasActivation<NDimSpatial,
                                                ...
                                                OutElementOp_>
{
    using DeviceOp = FusedConvMlsWaspPersistantKernelV1_CBA_Wrapper;
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "FusedConvMlsWaspPersistantKernelV1_CBA_Wrapper"
            << "-"
            << BlockSize << "-"
            << MWGs << "-"
            << NWGs << "-"
