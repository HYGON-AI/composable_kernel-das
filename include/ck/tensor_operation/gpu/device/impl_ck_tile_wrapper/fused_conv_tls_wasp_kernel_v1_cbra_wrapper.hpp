...
struct FusedConvTlsWaspKernelV1_CBRA_Wrapper
    : public DeviceGroupedConvFwdBiasAddActivation<NDimSpatial,
                                                   ...
                                                   OutElementOp_>
{
    using DeviceOp = FusedConvTlsWaspKernelV1_CBRA_Wrapper;
    ...
    static constexpr auto WarpTile = ck_tile::sequence<2, 1, 1, 2>{};
    ...
    using Kernel = ck_tile::FusedConvTlsWaspKernelV1<TilePartitioner, Pipeline, Epilogue>;
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "FusedConvTlsWaspKernelV1_CBRA_Wrapper"
            << "-"
            << BlockSize << "-"
            << MWGs << "-"
            << NWGs << "-"
