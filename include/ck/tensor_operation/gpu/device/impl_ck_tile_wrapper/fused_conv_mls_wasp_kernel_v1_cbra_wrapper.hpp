...
template <ck_tile::hcu_target_enum HcuArch,
...
struct FusedConvMlsWaspKernelV1_CBRA_Wrapper
    : public DeviceGroupedConvFwdBiasAddActivation<NDimSpatial,
                                                   ...
                                                   OutElementOp_>
{
    using DeviceOp = FusedConvMlsWaspKernelV1_CBRA_Wrapper;
    ...
    static constexpr auto WarpTile = ck_tile::sequence<1, 1, 2, 2>{};
    ...
    using BlockwiseGemm =
        ck_tile::remove_cvref_t<decltype(Policy::template GetBlockwiseGemm<HcuArch, Problem>())>;
    ...
    using Kernel = ck_tile::FusedConvMlsWaspKernelV1<HcuArch, TilePartitioner, Pipeline, Epilogue>;
            ...
            auto launch_kernel = [&](auto has_hot_loop) {
                return ck_tile::launch_kernel(
                    ...
                    ck_tile::make_kernel<BlockSize, MinBlockPerCU>(
                        Kernel{},
                        arg.kargs.num_group * arg.kargs.tile_partitioner.CalculateGridSize(),
                        BlockSize,
                        0,
                        arg.kargs,
                        has_hot_loop));
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "FusedConvMlsWaspKernelV1_CBRA_Wrapper"
            << "-"
            << BlockSize << "-"
            << MWGs << "-"
            << NWGs << "-"
