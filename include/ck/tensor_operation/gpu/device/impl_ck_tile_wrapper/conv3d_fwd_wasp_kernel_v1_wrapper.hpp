...
template <typename InLayout_,
          ...
          ck_tile::Conv3dFwdSpec ConvSpec,
...
struct Conv3dFwdWaspKernelV1_Wrapper : public DeviceGroupedConvFwd<3,
                                                                   InLayout_,
                                                                   WeiLayout_,
                                                                   OutLayout_,
                                                                   InDataType_,
                                                                   ...
                                                                   OutElementOp_>
{
    using DeviceOp = Conv3dFwdWaspKernelV1_Wrapper;
    ...
    using HostArgs = ck_tile::ConvFwdHostArgs<NDimSpatial>;
    ...
    struct Argument : public BaseArgument
    {
        Argument(const void* p_in,
                 ...
                 const WeiElementOp_&,
                 const OutElementOp_&)
            : num_group(in_g_n_c_wis_lengths[0])
        {
            ...
            auto launch_kernel = [&](auto has_hot_loop) {
                return ck_tile::launch_kernel(
                    ...
                    ck_tile::make_kernel<BlockSize, MinBlockPerCU>(
                        Kernel{},
                        arg.num_group * arg.kargs.tile_partitioner.CalculateGridSize(),
                        BlockSize,
                        0,
                        arg.kargs,
                        has_hot_loop));
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "Conv3dFwdWaspKernelV1_Wrapper"
            << "-"
            << BlockSize << "-"
            << MWGs << "-"
            << NWGs << "-"
