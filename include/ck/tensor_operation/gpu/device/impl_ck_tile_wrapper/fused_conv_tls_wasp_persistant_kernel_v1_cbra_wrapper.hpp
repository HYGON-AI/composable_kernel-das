...
struct FusedConvTlsWaspPersistantKernelV1_CBRA_Wrapper
    : public DeviceGroupedConvFwdBiasAddActivation<NDimSpatial,
                                                   ...
                                                   OutElementOp_>
{
    using DeviceOp = FusedConvTlsWaspPersistantKernelV1_CBRA_Wrapper;
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "FusedConvTlsWaspPersistantKernelV1_CBRA_Wrapper"
            << "-"
            << BlockSize << "-"
            << MWGs << "-"
            << NWGs << "-"
