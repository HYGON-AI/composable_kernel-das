...
struct FusedConvTlsWaspPersistantKernelV1_CBA_Wrapper
    : public DeviceGroupedConvFwdBiasActivation<NDimSpatial,
                                                ...
                                                OutElementOp_>
{
    using DeviceOp = FusedConvTlsWaspPersistantKernelV1_CBA_Wrapper;
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "FusedConvTlsWaspPersistantKernelV1_CBA_Wrapper"
            << "-"
            << BlockSize << "-"
            << MWGs << "-"
            << NWGs << "-"
