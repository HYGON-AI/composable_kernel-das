...
struct FusedConvMlsWaspPersistantKernelV1_CBRA_Wrapper
    : public DeviceGroupedConvFwdBiasAddActivation<NDimSpatial,
                                                   ...
                                                   OutElementOp_>
{
    using DeviceOp = FusedConvMlsWaspPersistantKernelV1_CBRA_Wrapper;
    ...
    using Kernel =
        ck_tile::FusedConvMlsWaspPersistantKernelV1<HcuArch, TilePartitioner, Pipeline, Epilogue>;
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "FusedConvMlsWaspPersistantKernelV1_CBRA_Wrapper"
            << "-"
            << BlockSize << "-"
            << MWGs << "-"
            << NWGs << "-"
