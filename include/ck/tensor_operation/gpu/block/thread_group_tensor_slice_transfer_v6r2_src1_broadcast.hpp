...
#include "ck/tensor_operation/gpu/thread/threadwise_tensor_slice_transfer_v6r2_src1_broadcast.hpp"
...
struct ThreadGroupTensorSliceTransfer_v6r2_src1_broadcast
{
    ...
    __device__ constexpr ThreadGroupTensorSliceTransfer_v6r2_src1_broadcast(
    ...
    using ThreadwiseTransfer =
        ThreadwiseTensorSliceTransfer_v6r2_src1_broadcast<Src0Data,
                                                          Src1Data,
                                                          DstData,
                                                          Src0Desc,
                                                          Src1Desc,
