...
struct TransformConvBwdDataToGemm_v1
{
        ...
        const std::array<index_t, NDimSpatial>& tildes)
    {
        ...
        else
        {
            ...
            const auto out_n_ak0_ak1_ydotslice_htildeslice_xdotslice_wtildeslice_grid_desc =
                transform_tensor_descriptor(
            ...
            const auto out_gemmak0_gemmmraw_gemmak1_grid_desc = transform_tensor_descriptor(
                out_n_ak0_ak1_ydotslice_htildeslice_xdotslice_wtildeslice_grid_desc,
                make_tuple(make_merge_transform(make_tuple(YDotSlice, XDotSlice, AK0)),
                           make_merge_transform(make_tuple(N, HTildeSlice, WTildeSlice)),
                           make_pass_through_transform(AK1)),
                make_tuple(Sequence<3, 5, 1>{}, Sequence<0, 4, 6>{}, Sequence<2>{}),
                make_tuple(Sequence<0>{}, Sequence<1>{}, Sequence<2>{}));
        ...
        const std::array<index_t, NDimSpatial>& tildes)
    {
        ...
        else
        {
            ...
            const auto wei_bk0_bk1_c_ydotslice_xdotslice_grid_desc =
            ...
            const auto wei_gemmbk0_gemmnraw_gemmbk1_grid_desc = transform_tensor_descriptor(
                wei_bk0_bk1_c_ydotslice_xdotslice_grid_desc,
                make_tuple(make_merge_transform(make_tuple(YDotSlice, XDotSlice, BK0)),
                           make_pass_through_transform(C),
                           make_pass_through_transform(BK1)),
                make_tuple(Sequence<3, 4, 0>{}, Sequence<2>{}, Sequence<1>{}),
                make_tuple(Sequence<0>{}, Sequence<1>{}, Sequence<2>{}));
        ...
        const std::array<index_t, NDimSpatial>& tildes)
    {
        ...
        else
        {
            ...
            const auto out_n_k_ak00_ak1_ydotslice_htildeslice_xdotslice_wtildeslice_grid_desc =
                transform_tensor_descriptor(
                    out_n_ktotal_ydot_htilde_xdot_wtilde_grid_desc,
                    make_tuple(make_pass_through_transform(N),
                               make_unmerge_transform(make_tuple(K, AK00, AK1)),
                               make_slice_transform(YDot, I0, YDotSlice),
                               make_slice_transform(HTilde, IHTildeSliceBegin, HTildeSlice),
                               make_slice_transform(XDot, I0, XDotSlice),
                               make_slice_transform(WTilde, IWTildeSliceBegin, WTildeSlice)),
            ...
            const auto out_gemmak0_gemmmraw_gemmak1_grid_desc = transform_tensor_descriptor(
                out_n_k_ak00_ak1_ydotslice_htildeslice_xdotslice_wtildeslice_grid_desc,
                make_tuple(make_merge_transform(make_tuple(K, YDotSlice, XDotSlice, AK00)),
                           make_merge_transform(make_tuple(N, HTildeSlice, WTildeSlice)),
                           make_pass_through_transform(AK1)),
                make_tuple(Sequence<1, 4, 6, 2>{}, Sequence<0, 5, 7>{}, Sequence<3>{}),
                make_tuple(Sequence<0>{}, Sequence<1>{}, Sequence<2>{}));
        ...
        const std::array<index_t, NDimSpatial>& tildes)
    {
        ...
        else
        {
            ...
            const auto wei_k_bk00_bk1_ctotal_ydotslice_xdotslice_grid_desc =
                transform_tensor_descriptor(
                    wei_ktotal_c_ydot_ytilde_xdot_xtilde_c32_grid_desc,
                    make_tuple(make_unmerge_transform(make_tuple(K, BK00, BK1)),
            ...
            const auto wei_gemmbk0_gemmnraw_gemmbk1_grid_desc = transform_tensor_descriptor(
                wei_k_bk00_bk1_ctotal_ydotslice_xdotslice_grid_desc,
                make_tuple(make_merge_transform(make_tuple(K, YDotSlice, XDotSlice, BK00)),
                           make_pass_through_transform(C_TOTAL),
                           make_pass_through_transform(BK1)),
                make_tuple(Sequence<0, 4, 5, 1>{}, Sequence<3>{}, Sequence<2>{}),
                make_tuple(Sequence<0>{}, Sequence<1>{}, Sequence<2>{}));
    ...
    template <typename CLayout,
              typename std::enable_if<
                  NDimSpatial == 2 && (is_same_v<CLayout, tensor_layout::convolution::NGCHWc32>),
                  bool>::type = false>
    static auto
    MakeCDescriptor_M_N(const std::array<index_t, NDimSpatial + 3>& out_g_n_k_wos_lengths,
                        const std::array<index_t, NDimSpatial + 3>& /* out_g_n_k_wos_strides */,
