...
#include "ck_tile/core/arch/hcu_mls_atom_gfx946.hpp"
...
struct mls_traits<gfx946_mls_32x16_b16, Alt>
{
...
template <index_t Alt>
struct mls_traits<gfx946_mls_16x32_trans_b16, Alt>
{
    static_assert(Alt == 1 || Alt == 2, "Unsupported interleave config");
...
template <index_t Alt>
struct mls_traits<gfx946_mls_32x32_b16, Alt>
{
    static_assert(Alt == 1 || Alt == 2, "Unsupported interleave config");
...
template <index_t Alt>
struct mls_traits<gfx946_mls_32x32_trans_b16, Alt>
{
    static_assert(Alt == 1 || Alt == 2, "Unsupported interleave config");
...
template <index_t Alt>
struct mls_traits<gfx946_mls_64x16_b16, Alt>
{
    static_assert(Alt == 1 || Alt == 2, "Unsupported interleave config");
...
template <index_t Alt>
struct mls_traits<gfx946_mls_16x64_trans_b16, Alt>
{
    static_assert(Alt == 1 || Alt == 2, "Unsupported interleave config");
...
template <index_t Alt>
struct mls_traits<gfx946_mls_64x16_b8, Alt>
{
...
template <index_t Alt>
struct mls_traits<gfx946_mls_16x64_trans_b8, Alt>
{
    static_assert(Alt == 1 || Alt == 2 || Alt == 4, "Unsupported interleave config");
...
template <index_t Alt>
struct mls_traits<gfx946_mls_64x32_b8, Alt>
{
    static_assert(Alt == 1 || Alt == 2 || Alt == 4, "Unsupported interleave config");
...
template <index_t Alt>
struct mls_traits<gfx946_mls_32x64_trans_b8, Alt>
{
    static_assert(Alt == 1 || Alt == 2 || Alt == 4, "Unsupported interleave config");
...
template <index_t Alt>
struct mls_traits<gfx946_mls_128x16_b8, Alt>
{
    static_assert(Alt == 1 || Alt == 2 || Alt == 4, "Unsupported interleave config");
...
template <index_t Alt>
struct mls_traits<gfx946_mls_16x128_trans_b8, Alt>
{
    static_assert(Alt == 1 || Alt == 2 || Alt == 4, "Unsupported interleave config");
