...
#include "ck_tile/core/arch/hcu_mls_traits_gfx938.hpp"
 ...
 * constructed by mls instruction on gfx938
 * make_lds_desc() provides logical lds descriptor
 * for warp offset calculation
 */

template <index_t Alt>
struct tile_window_mls_gfx938_256x64_trans_b16
{
    using MlsAtom   = gfx938_mls_16x64_trans_b16;
    ...
    CK_TILE_DEVICE static constexpr auto make_lds_desc()
    {
        ...
        else if constexpr(Alt == 2)
        {
            ...
            constexpr auto lds_desc_mn_k = transform_tensor_descriptor(
                ...
                make_tuple(make_merge_transform(make_tuple(
                               tile_load_issue_mn_outer, MlsTraits::kSlots, MlsTraits::kMN)),
                           make_merge_transform(make_tuple(MlsTraits::kK0, MlsTraits::kK1))),
        ...
        {
            static_assert(false, "wrong! only interleave 1 and 2 are supported");
        }
    }
};

template <index_t Alt>
struct tile_window_mls_gfx938_128x64_trans_b16
{
    using MlsAtom   = gfx938_mls_16x64_trans_b16;
    using MlsTraits = mls_traits<MlsAtom, Alt>;
...
template <index_t Alt>
struct tile_window_mls_gfx938_64x64_trans_b16
{
    using MlsAtom   = gfx938_mls_16x64_trans_b16;
    using MlsTraits = mls_traits<MlsAtom, Alt>;
...
template <index_t Alt>
struct tile_window_mls_gfx938_256x32_trans_b16
{
    using MlsAtom   = gfx938_mls_32x32_trans_b16;
    using MlsTraits = mls_traits<MlsAtom, Alt>;
...
template <index_t Alt>
struct tile_window_mls_gfx938_128x32_trans_b16
{
    using MlsAtom   = gfx938_mls_32x32_trans_b16;
    using MlsTraits = mls_traits<MlsAtom, Alt>;
...
template <index_t Alt>
struct tile_window_mls_gfx938_64x32_trans_b16
{
    using MlsAtom   = gfx938_mls_16x32_trans_b16;
    using MlsTraits = mls_traits<MlsAtom, Alt>;
