...
template <typename BottomTensorView_,
          ...
          typename Layout_,
          index_t CStep_>
struct tile_window_conv2d_fwd_activation_opt
                                        ...
                                        false>
{
    ...
    CK_TILE_DEVICE constexpr tile_window_conv2d_fwd_activation_opt() = default;

    CK_TILE_DEVICE constexpr tile_window_conv2d_fwd_activation_opt(
...
template <typename BottomTensorView_,
          ...
          typename Layout_,
          index_t CStep_>
struct tile_window_conv2d_fwd_activation_opt<BottomTensorView_,
                                             WindowLengths_,
                                             sequence<1, 1>,
                                             StaticTileDistribution_,
                                             Layout_,
...
template <typename TensorView_,
          ...
          typename Layout_,
          index_t CStep_>
CK_TILE_DEVICE constexpr auto make_tile_window_conv_fwd_activation_opt(
    ...
    number<CStep_>)
{
    if constexpr(std::is_same_v<Layout_, tensor_layout::convolution::NHWGC>)
    {
        return tile_window_conv2d_fwd_activation_opt<remove_cvref_t<TensorView_>,
