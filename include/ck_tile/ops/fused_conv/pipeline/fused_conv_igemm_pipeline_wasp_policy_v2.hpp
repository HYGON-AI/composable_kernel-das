...
struct FusedConvIgemmPipelineWaspPolicyV2
{
                ...
                if constexpr(KPerBlock == 32)
                {
                    ...
                    return make_static_tile_distribution(
                        tile_distribution_encoding<
                            sequence<1>,
                            tuple<sequence<1>,
                                  sequence<MLaneSlice, MLaneCluster0, MWarps, MLaneCluster1>,
                                  sequence<KLaneCluster, KLaneSlice>>,
                            tuple<sequence<1, 2>, sequence<2, 2, 3>>,
                            tuple<sequence<0, 2>, sequence<1, 3, 0>>,
                            sequence<2, 3>,
                            sequence<0, 1>>{},
                        bool_constant<true>{},
                ...
                else if constexpr(KPerBlock == 64)
                {
                    ...
                    return make_static_tile_distribution(
                        tile_distribution_encoding<
                            sequence<1>,
                            tuple<sequence<1>,
                                  sequence<MLaneSlice0, MLaneCluster, MWarps, MLaneSlice1>,
                                  sequence<KLaneCluster, KLaneSlice>>,
                            tuple<sequence<1, 2>, sequence<2, 3>>,
                            tuple<sequence<0, 2>, sequence<1, 0>>,
                            sequence<2, 2, 3>,
                            sequence<0, 3, 1>>{},
                        bool_constant<true>{},
                        number<Problem::SubWGSize>{});
                ...
                if constexpr(KPerBlock == 32)
                {
                    ...
                    return make_static_tile_distribution(
                        tile_distribution_encoding<
                            sequence<1>,
                            tuple<sequence<1>,
                                  sequence<NLaneSlice, NLaneCluster0, NWarps, NLaneCluster1>,
                                  sequence<KLaneCluster, KLaneSlice>>,
                            tuple<sequence<1, 2>, sequence<2, 2, 3>>,
                            tuple<sequence<0, 2>, sequence<1, 3, 0>>,
                            sequence<2, 3>,
                ...
                else if constexpr(KPerBlock == 64)
                {
                    ...
                    return make_static_tile_distribution(
                        tile_distribution_encoding<
                            sequence<1>,
                            tuple<sequence<1>,
                                  sequence<NLaneSlice0, NLaneCluster, NWarps, NLaneSlice1>,
                                  sequence<KLaneCluster, KLaneSlice>>,
                            tuple<sequence<1, 2>, sequence<2, 3>>,
                            tuple<sequence<0, 2>, sequence<1, 0>>,
                            sequence<2, 2, 3>,
    ...
    {
        return BlockGemmMmacTNAsmemBSmemCregWaspV2<Problem>{};
    }
};
