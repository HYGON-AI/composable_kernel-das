          ...
          mixed_prec_compute_type_t<ComputeDataType_, ADataType_, BDataType_>>
{
    ...
    static constexpr index_t kMRepeat      = BlockGemmShape::WarpTile::at(number<0>{}) / 16;
    static constexpr index_t kNRepeat      = BlockGemmShape::WarpTile::at(number<1>{}) / 16;
    static constexpr index_t kMInterleave  = 1;
    static constexpr index_t kNInterleave  = 1;
...
#if defined(__gfx950__) || !CK_TILE_ARCH_SUPPORTS_FP4
