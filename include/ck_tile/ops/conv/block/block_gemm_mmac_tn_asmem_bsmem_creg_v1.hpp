...
struct BlockGemmMmacTNAsmemBSmemCregV1
{
    ...
    CK_TILE_HOST_DEVICE constexpr BlockGemmMmacTNAsmemBSmemCregV1()
    {
    ...
    CK_TILE_DEVICE auto LdsLoadA(const ALdsWindow& a_lds_window) const
    {
        ...
        statically_indexed_array<
            statically_indexed_array<decltype(load_tile(warp_window)), KWarpIter>,
            MWarpIter>
            warp_tensors;
        ...
        static_for<0, num_access, 1>{}([&](auto i) {
            ...
            warp_tensors(m_warp_iter)(k_warp_iter) = load_tile(warp_window);
    ...
    CK_TILE_DEVICE auto LdsLoadB(const BLdsWindow& b_lds_window) const
    {
        ...
        auto warp_window =
            make_tile_window(b_lds_window.get_bottom_tensor_view(),
        ...
        static_for<0, num_access, 1>{}([&](auto i) {
            ...
            warp_tensors(n_warp_iter)(k_warp_iter) = load_tile(warp_window);
