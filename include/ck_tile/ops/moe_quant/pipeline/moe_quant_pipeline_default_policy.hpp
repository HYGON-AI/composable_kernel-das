...
struct quantPipelineDefaultPolicy
{
    ...
    CK_TILE_DEVICE static constexpr auto MakeXBlockTileDistribution()
    {
        ...
        return make_static_tile_distribution(
            tile_distribution_encoding<
                sequence<>,
                tuple<sequence<S::Repeat_M, S::WarpPerBlock_M, S::ThreadPerWarp_M, S::Vector_M>,    // <32, 4, 1, 1>
                      sequence<S::Repeat_N, S::WarpPerBlock_N, S::ThreadPerWarp_N, S::Vector_N>>,   // <1, 1, 64, 2>
    ...
    template <typename Problem>
    CK_TILE_DEVICE static constexpr auto MakeScaleBlockTileDistribution()
    {
        using S = typename Problem::BlockShape;
    ...
    CK_TILE_HOST_DEVICE static constexpr index_t GetSmemSize()
    {
        ...
        {
            using P_ = BlockReduce2dProblem<typename Problem::InputDataType,
                                            typename Problem::ComputeDataType,
                                            typename Problem::BlockShape>;

            using block_reduce2d = BlockReduce2d<P_>;
            using x_block_tile =
                decltype(make_static_distributed_tensor<typename Problem::InputDataType>(
