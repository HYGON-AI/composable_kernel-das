...
// clang-format off
// fp16
template<> struct WarpGemmMmacDispatcher<half_t, half_t, float, 32, 32, 16, false, 2, 2, 1, 1> { using Type = WarpGemmMmacF16F16F32_WT32x32x16_MR2NR2MI1NI1; };
template<> struct WarpGemmMmacDispatcher<half_t, half_t, float, 32, 32, 16, false, 1, 1, 2, 2> { using Type = WarpGemmMmacF16F16F32_WT32x32x16_MR1NR1MI2NI2; };
...
template<> struct WarpGemmMmacDispatcher<half_t, half_t, float, 32, 64, 16, false, 2, 4, 1, 1> { using Type = WarpGemmMmacF16F16F32_WT32x64x16_MR2NR4MI1NI1; };
template<> struct WarpGemmMmacDispatcher<half_t, half_t, float, 128, 64, 16, false, 8, 4, 1, 1> { using Type = WarpGemmMmacF16F16F32_WT128x64x16_MR8NR4MI1NI1; };

// [HCU移植] FMHA BWD 移植新增：把 16x16x{32,16}（含 TransC）注册进 MMAC dispatcher。
// fp16 FMHA BWD 16x16 warp tiles (basic MMAC layout)
template<> struct WarpGemmMmacDispatcher<half_t, half_t, float, 16, 16, 32, false, 1, 1, 1, 1> { using Type = WarpGemmMmacF16F16F32_WT16x16x32_MR1NR1MI1NI1; };
template<> struct WarpGemmMmacDispatcher<half_t, half_t, float, 16, 16, 16, false, 1, 1, 1, 1> { using Type = WarpGemmMmacF16F16F32_WT16x16x16_MR1NR1MI1NI1; };
template<> struct WarpGemmMmacDispatcher<half_t, half_t, float, 16, 16, 32, true,  1, 1, 1, 1> { using Type = WarpGemmMmacF16F16F32_WT16x16x32_MR1NR1MI1NI1_TRANSC; };
template<> struct WarpGemmMmacDispatcher<half_t, half_t, float, 16, 16, 16, true,  1, 1, 1, 1> { using Type = WarpGemmMmacF16F16F32_WT16x16x16_MR1NR1MI1NI1_TRANSC; };

// bf16
template<> struct WarpGemmMmacDispatcher<bf16_t, bf16_t, float, 32, 32, 16, false, 2, 2, 1, 1> { using Type = WarpGemmMmacBF16BF16F32_WT32x32x16_MR2NR2MI1NI1; };
template<> struct WarpGemmMmacDispatcher<bf16_t, bf16_t, float, 32, 32, 16, false, 1, 1, 2, 2> { using Type = WarpGemmMmacBF16BF16F32_WT32x32x16_MR1NR1MI2NI2; };
...
template<> struct WarpGemmMmacDispatcher<bf16_t, bf16_t, float, 32, 64, 32, false, 2, 4, 1, 1> { using Type = WarpGemmMmacBF16BF16F32_WT32x64x32_MR2NR4MI1NI1; };
template<> struct WarpGemmMmacDispatcher<bf16_t, bf16_t, float, 32, 64, 16, false, 2, 4, 1, 1> { using Type = WarpGemmMmacBF16BF16F32_WT32x64x16_MR2NR4MI1NI1; };
template<> struct WarpGemmMmacDispatcher<bf16_t, bf16_t, float, 128, 64, 16, false, 8, 4, 1, 1> { using Type = WarpGemmMmacBF16BF16F32_WT128x64x16_MR8NR4MI1NI1; };
// bf16 FMHA BWD 16x16 warp tiles (basic MMAC layout)
template<> struct WarpGemmMmacDispatcher<bf16_t, bf16_t, float, 16, 16, 32, false, 1, 1, 1, 1> { using Type = WarpGemmMmacBF16BF16F32_WT16x16x32_MR1NR1MI1NI1; };
template<> struct WarpGemmMmacDispatcher<bf16_t, bf16_t, float, 16, 16, 16, false, 1, 1, 1, 1> { using Type = WarpGemmMmacBF16BF16F32_WT16x16x16_MR1NR1MI1NI1; };
template<> struct WarpGemmMmacDispatcher<bf16_t, bf16_t, float, 16, 16, 32, true,  1, 1, 1, 1> { using Type = WarpGemmMmacBF16BF16F32_WT16x16x32_MR1NR1MI1NI1_TRANSC; };
template<> struct WarpGemmMmacDispatcher<bf16_t, bf16_t, float, 16, 16, 16, true,  1, 1, 1, 1> { using Type = WarpGemmMmacBF16BF16F32_WT16x16x16_MR1NR1MI1NI1_TRANSC; };
...
template<> struct WarpGemmMmacDispatcher<fp8_t, bf8_t, float, 32, 64, 32, false, 2, 4, 1, 1> { using Type = WarpGemmMmacfp8bf8f32_WT32x64x32_MR2NR4MI1NI1; };
...
template<> struct WarpGemmMmacDispatcher<bf8_t, fp8_t, float, 32, 64, 32, false, 2, 4, 1, 1> { using Type = WarpGemmMmacbf8fp8f32_WT32x64x32_MR2NR4MI1NI1; };
