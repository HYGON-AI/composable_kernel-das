...
// interleaved layout
struct BaseNGCHWc : public BaseTensorLayout
{
};

template <int x_>
struct NGCHWc : public BaseNGCHWc
{
...
template <int x_>
struct NGKHWk : public BaseNGCHWc
{
    static constexpr int x            = x_;
    static constexpr const char* name = "NGKHWk";
};

struct BaseGKCYXc : public BaseTensorLayout
{
};

template <int x_>
struct GKCYXc : public BaseGKCYXc
{
    static constexpr int x            = x_;
