...
struct FusedMoeGemmPipelineFlatmmW8A8QuantPolicy
{
    ...
    CK_TILE_HOST_DEVICE static constexpr auto MakeGlobalTileDistribution_G()
    {
        ...
        if constexpr (PermuteEnum == FusedMoeGemmWeightPermuteEnum::no_permute) {
            ...
            return make_static_tile_distribution(
                tile_distribution_encoding<
                    sequence<1>,
                    tuple<sequence<number<NumWarps>{},
                                    number<NLane>{},
                                    number<NInterleave>{}>,
                          sequence<number<KLane>{},
                                    number<KVecotrLength * KRepeat>{}>>,
        ...
        constexpr auto c_output_dstr_encoding =
            tile_distribution_encoding<sequence<>,
                                       tuple<sequence<S_::Repeat_M1,
                                                      S_::WarpPerBlock_M1,              // 1
                                                      number<1>{},
                                                      WarpGemm::MInterleave,
                                                      number<1>{},
                                                      WarpGemm::Impl::kCMLane,          // 4
                                                      WarpGemm::Impl::kCM1PerLane>,     // 1
                                             sequence<S_::Repeat_N1,
                                                      S_::WarpPerBlock_N1,              // 4
                                                      WarpGemm::NRepeat,
                                                      WarpGemm::NInterleave,
                                                      WarpGemm::Impl::kCNLane,          // 16
                                                      WarpGemm::Impl::kCNPerLane>>,     // 1
    ...
    CK_TILE_HOST_DEVICE static constexpr auto GetWarpGemm0()
    {
        ...
        if constexpr (Problem::Traits::PermuteEnum == FusedMoeGemmWeightPermuteEnum::no_permute)
        {
            ...
            {
                return WarpGemmMmacI8I8I32_WT16x32x128_MR1NR1MI1NI2{};

            } else if constexpr(std::is_same_v<typename Problem::GDataType, ck_tile::int8_t> &&
                            S_::Warp_M0 == 16 && S_::Warp_N0 == 64 && S_::Warp_K0 == 128)
            {
                return WarpGemmMmacI8I8I32_WT16x64x128_MR1NR1MI1NI4{};
            }
        }
        else if constexpr(Problem::Traits::PermuteEnum == FusedMoeGemmWeightPermuteEnum::permute_bd) 
        {
            if constexpr(std::is_same_v<typename Problem::GDataType, ck_tile::int8_t> &&
                S_::Warp_M0 == 16 && S_::Warp_N0 == 32 && S_::Warp_K0 == 128)
            {
    ...
    CK_TILE_HOST_DEVICE static constexpr auto GetWarpGemm1()
    {
        ...
        if constexpr (Problem::Traits::PermuteEnum == FusedMoeGemmWeightPermuteEnum::no_permute)
        {
            ...
            {
                return WarpGemmMmacI8I8I32_WT16x32x128_MR1NR2MI1NI1_TRANSC{};
    
            } else if constexpr(std::is_same_v<typename Problem::DDataType, ck_tile::int8_t> &&
                S_::Warp_M1 == 16 && S_::Warp_N1 == 32 && S_::Warp_K1 == 256)
            {
                return WarpGemmMmacI8I8I32_WT16x32x256_MR1NR2MI1NI1_TRANSC{};
            }
        }
        else if constexpr(Problem::Traits::PermuteEnum == FusedMoeGemmWeightPermuteEnum::permute_bd)
        {
