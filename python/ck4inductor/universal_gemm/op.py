...
class CKGemmOperation:
    """HCU DeviceGemm_Xdl_CShuffleV3 universal GEMM template parameters."""

    a_layout: str
    b_layout: str
    ds_layouts: Tuple[str, ...]
    c_layout: str
    a_element_dtype: str
    b_element_dtype: str
    ds_element_dtypes: Tuple[str, ...]
    c_element_dtype: str
    acc_dtype: str
    c_shuffle_dtype: str
    ...
    c_shuffle_block_transfer_cluster_lengths_m_block_m_per_block_n_block_n_per_block: Tuple[int, ...]
    c_shuffle_block_transfer_scalar_per_vector_n_per_block: Union[int, Tuple[int, ...]]
    ...
    def __post_init__(self):
        self.a_block_lds_extra_m = _format_cpp_literal(self.a_block_lds_extra_m)
        self.b_block_lds_extra_n = _format_cpp_literal(self.b_block_lds_extra_n)
