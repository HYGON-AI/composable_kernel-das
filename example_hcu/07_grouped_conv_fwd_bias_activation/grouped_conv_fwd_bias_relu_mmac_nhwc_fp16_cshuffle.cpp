...
using DeviceGroupedConvInstance =
    ck::tensor_operation::device::DeviceGroupedConvFwdBiasActivation_mmac_v2r1_cshuffle<
        2,
        InLayout,
        WeiLayout,
        OutLayout,
...
#elif (INSTANCE_ID == 2)
using DeviceGroupedConvInstance =
    ck::tensor_operation::device::DeviceGroupedConvFwdBiasActivation_mmac_v2_cshuffle<
        2,
        InLayout,
        WeiLayout,
        OutLayout,
                          ...
                          const OutElementOp& out_element_op)
{
    ...
    default:
        ...
        bias.GenerateTensorValue(GeneratorTensor_3<BiasDataType>{0, 0});
    }
