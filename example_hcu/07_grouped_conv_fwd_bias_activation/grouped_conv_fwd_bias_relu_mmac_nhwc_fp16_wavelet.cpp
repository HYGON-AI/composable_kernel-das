...
#include "ck/tensor_operation/gpu/device/impl/device_grouped_conv_fwd_bias_activation_mmac_v2_wavelet.hpp"
...
using DeviceGroupedConvInstance =
    ck::tensor_operation::device::DeviceGroupedConvFwdBiasActivation_mmac_v2_wavelet<
        2,
        InLayout,
        WeiLayout,
        OutLayout,
...
bool run_grouped_conv_fwd_example(int argc, char* argv[])
{
    ...
    ck::utils::conv::ConvParam conv_param{
        2, 1, 1, 32, 32, {1, 1}, {4, 4}, {1, 1}, {1, 1}, {0, 0}, {0, 0}};
