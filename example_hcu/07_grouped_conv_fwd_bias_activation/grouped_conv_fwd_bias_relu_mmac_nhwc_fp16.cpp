...
#include "ck/tensor_operation/gpu/device/impl/device_grouped_conv_fwd_bias_activation_mmac_v2.hpp"
...
using DeviceGroupedConvInstance =
    ck::tensor_operation::device::DeviceGroupedConvFwdBiasActivation_mmac_v2<2,
                                                                             InLayout,
                                                                             WeiLayout,
                                                                             OutLayout,
                                                                             InDataType,
