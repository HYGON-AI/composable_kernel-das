...
#include "ck/tensor_operation/gpu/device/impl/device_gemm_bias_activation_mmac_tn_v2.hpp"
...
using DeviceGemmInstance0 =
    ck::tensor_operation::device::DeviceGemmBiasActivation_mmac_tn_mk_nk_mn_v2<
        ADataType,
        BDataType,
        AccDataType,
        CDataType,
