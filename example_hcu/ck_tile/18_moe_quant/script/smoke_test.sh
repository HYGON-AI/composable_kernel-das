...
EXE=build/bin/tile_example_moe_quant
...
$EXE -prec_i=$pr_i -prec_o=$pr_o -t=22  -h=255 
$EXE -prec_i=$pr_i -prec_o=$pr_o -t=7   -h=599
$EXE -prec_i=$pr_i -prec_o=$pr_o -t=19  -h=512
$EXE -prec_i=$pr_i -prec_o=$pr_o -t=33  -h=313
$EXE -prec_i=$pr_i -prec_o=$pr_o -t=11  -h=510
$EXE -prec_i=$pr_i -prec_o=$pr_o -t=171 -h=676
$EXE -prec_i=$pr_i -prec_o=$pr_o -t=91  -h=636
$EXE -prec_i=$pr_i -prec_o=$pr_o -t=12  -h=768
$EXE -prec_i=$pr_i -prec_o=$pr_o -t=100 -h=766
$EXE -prec_i=$pr_i -prec_o=$pr_o -t=31  -h=1024
$EXE -prec_i=$pr_i -prec_o=$pr_o -t=64  -h=1000
