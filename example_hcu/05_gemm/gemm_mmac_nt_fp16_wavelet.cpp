...
#include "ck/tensor_operation/gpu/device/impl/device_gemm_mmac_nt_v1_wavelet.hpp"
...
using DeviceGemmInstance0 =
    ck::tensor_operation::device::DeviceGemm_mmac_nt_m0k0k1m1_n0k0k1n1_mn_v1_wavelet<
        ADataType,
        BDataType,
        CDataType,
        AccDataType,
