...
#include "ck/tensor_operation/gpu/device/impl/device_gemm_mmac_nn_v1_cshuffle.hpp"
...
using DeviceGemmInstance0 =
    ck::tensor_operation::device::DeviceGemm_mmac_nn_m0k0k1m1_nk_nm_v1_cshuffle<
        ADataType,
        BDataType,
        AccDataType,
        CDataType,
