...
#include "ck/tensor_operation/gpu/device/impl/device_gemm_mmac_tt_v2_cshuffle_nm.hpp"
...
using DeviceGemmInstance0 =
    ck::tensor_operation::device::DeviceGemm_mmac_tt_mk_n0k0k1n1_nm_v2_cshuffle<
        ADataType,
        BDataType,
        AccDataType,
        CDataType,
