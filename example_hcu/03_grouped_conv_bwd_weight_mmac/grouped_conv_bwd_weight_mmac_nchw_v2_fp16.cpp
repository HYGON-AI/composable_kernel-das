...
using DeviceGroupedConvInstance =
    ck::tensor_operation::device::DeviceGroupedConvBwdWeight_mmac_nchw_v2<
        2,
        OutLayout,
        InLayout,
        WeiLayout,
...
#define DefaultConvParams                                                       \
    ...
    {                                                                           \
        2, 1, 256, 256, 256, {1, 1}, {28, 28}, {1, 1}, {1, 1}, {0, 0}, { 0, 0 } \
    }
                         ...
                         const WeiElementOp& wei_element_op)
{
    ...
    if(config.do_verification)
    {
        ...
        return ck::utils::check_err(
            wei_device.mData, wei_host.mData, "Error: Incorrect results!", 1e-3, 1e-2);
    }
