...
#include "ck/tensor_operation/gpu/device/impl/device_grouped_conv_bwd_weight_mmac_v2_wavelet.hpp"
...
using DeviceGroupedConvInstance =
    ck::tensor_operation::device::DeviceGroupedConvBwdWeight_mmac_v2_wavelet<
        2,
        OutLayout,
        InLayout,
        WeiLayout,
