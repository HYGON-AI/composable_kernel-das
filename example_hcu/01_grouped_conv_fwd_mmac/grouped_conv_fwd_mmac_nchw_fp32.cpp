...
#include "ck/tensor_operation/gpu/device/impl/device_grouped_conv_fwd_mmac.hpp"
...
using InLayout  = ctc::GNCHW;
using WeiLayout = ctc::GKCYX;
using OutLayout = ctc::GNKHW;
using DeviceGroupedConvInstance =
    ck::tensor_operation::device::DeviceGroupedConvFwd_Mmac<2,
                                                            InLayout,
                                                            WeiLayout,
                                                            OutLayout,
                                                            InDataType,
