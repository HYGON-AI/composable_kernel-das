                         ...
                         double epsilon)
{
    ...
    using DeviceBatchNormFwdInstance =
        ck::tensor_operation::device::DeviceBatchNormFwdV2Impl<InOutDataType,
                                                             InOutDataType,
                                                             AccDataType,
                                                             ...
                                                             256,
                                                             1,
                                                             256,//number of K thread
                                                             2,
                                                             8, //KThreadSliceSize
                                                             4, // K10
                                                             4, //vectordim
                                                             8, // corresponding to KThreadSliceSize
                                                             8,// corresponding to KThreadSliceSize
                                                             2,
                                                             2,
                                                             2,
    ...
    auto argument_ptr = batchnorm_fwd.MakeArgumentPointer(
        ...
        i_inOutStrides,
        i_inOutStrides,
        {0, 2, 3}, // indicates physical indices of reduce dimensions in lengths[] and strides[]
    ...
    if(time_kernel)
    {
        ...
        size_t invariant_length = inOutLengths[1];
    ...
    if(do_verification)
    {
        ...
        pass = pass && ck::utils::check_err(y, y_ref, "BatchNorm output:");
        ...
        if(updateMovingAverage)
        {
            ...
            pass = pass && ck::utils::check_err(
                               resultRunningMean, resultRunningMean_ref, "Running mean:");
            pass = pass && ck::utils::check_err(
                               resultRunningVariance, resultRunningVariance_ref, "Running variance:");
        };
        ...
        if(saveMeanAndInvVariance)
        {
            ...
            pass = pass &&
                   ck::utils::check_err(resultSaveMean, resultSaveMean_ref, "Saved mean:");
            pass = pass && ck::utils::check_err(
    ...
    if(argc > 1)
    {
        ...
        if(arg.data_type == 0)
        {
            if(arg.use_multiblock_welford)
                ...
                printf("not support single block...\n");
