...
using DeviceGroupedConvInstance =
    ck::tensor_operation::device::DeviceGroupedConvBwdData_mmac_v2_cshuffle<
        2,
        OutLayout,
        WeiLayout,
        InLayout,
        ...
        1,                 // MmmacInterleave
        2,                 // NmmacInterleave
        S<1, 64, 4>,       // ABlockTransferThreadClusterLengths_B_M_K
        2,                 // ABlockTransferSrcVectorDim
        4,                 // ABlockTransferSrcScalarPerVector
        S<1, 2, 1, 16, 8>, // BBlockTransferThreadClusterLengths_B_N0_K0_K1_N1
