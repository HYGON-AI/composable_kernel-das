...
using DeviceGroupedConvInstance =
    ck::tensor_operation::device::DeviceGroupedConvBwdData_mmac_nchw_v2_cshuffle<
        2,
        OutLayout,
        WeiLayout,
        InLayout,
        ...
        2,                 // MmmacInterleave
        1,                 // NmmacInterleave
        S<1, 2, 1, 16, 4>, // ABlockTransferThreadClusterLengths_B_M_K
        4,                 // ABlockTransferSrcVectorDim
        8,                 // ABlockTransferSrcScalarPerVector
        S<1, 2, 1, 16, 4>, // BBlockTransferThreadClusterLengths_B_N0_K0_K1_N1
...
#define DefaultConvParams                                                      \
    ...
    {                                                                          \
        2, 1, 1, 256, 64, {1, 1}, {28, 28}, {1, 1}, {1, 1}, {0, 0}, { 0, 0 }   \
    }
