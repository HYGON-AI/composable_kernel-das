...
using OutLayout = ck::tensor_layout::convolution::GNKHW;
using WeiLayout = ck::tensor_layout::convolution::GKCYX;
using InLayout  = ck::tensor_layout::convolution::GNCHW;
...
using DeviceGroupedConvInstance =
    ck::tensor_operation::device::DeviceGroupedConvBwdData_Mmac<2,
                                                                OutLayout,
                                                                WeiLayout,
                                                                InLayout,
                                                                OutDataType,
                                                                ...
                                                                S<0, 2, 1>,
                                                                1, // gemm m
                                                                1, // src vector on gemm m
                                                                1, // dst vector on gemm k1
                                                                false,
                                                                S<4, 64, 1>,
                                                                S<0, 2, 1>,
                                                                S<0, 2, 1>,
                                                                1, // gemm n
                                                                1, // src vector on gemm n
                                                                1, // dst vector on gemm k1
                                                                false>;
...
#define DefaultConvParams                                                                 \
    ...
    {                                                                                     \
        NDimSpatial, 1, 128, 128, 128, {1, 1}, {56, 56}, {1, 1}, {1, 1}, {0, 0}, { 0, 0 } \
    }
