...
using DeviceGroupedConvInstance =
    ck::tensor_operation::device::DeviceGroupedConvBwdData_Mmac_CShuffle<2,
                                                                         OutLayout,
                                                                         WeiLayout,
                                                                         InLayout,
                                                                         OutDataType,
                                                                         ...
                                                                         S<1, 0, 2>,
                                                                         2, // gemm k1
                                                                         8, // src vector on gemm k1
                                                                         8, // dst vector on gemm k1
                                                                         true,
                                                                         S<4, 64, 1>,
                                                                         S<0, 2, 1>,
                                                                         S<0, 2, 1>,
                                                                         1, // gemm n
                                                                         2, // src vector on gemm n
                                                                         8, // dst vector on gemm k
                                                                         true,
                                                                         1,
                                                                         1,
                                                                         S<1, 1, 32, 1, 1, 8>,
