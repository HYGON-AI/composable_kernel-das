...
#include "ck/tensor_operation/gpu/device/impl/device_grouped_conv_bwd_data_mmac_v2.hpp"
...
using DeviceGroupedConvInstance = ck::tensor_operation::device::DeviceGroupedConvBwdData_mmac_v2<
    2,
    OutLayout,
    WeiLayout,
    InLayout,
