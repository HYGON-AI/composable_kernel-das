...
enum struct ConvLayout
{
    ...
    NGCHW_GKCYXc32_NGKHWk32,    // 3
    NGCHWc16_GKCYXc16_NGKHWk16, // 4
    NGCHWc16_GKCYXc16_NGKHW,    // 5
    NDHWGC_GKZYXC_NDHWGK,       // 6
};
...
static void print_helper_msg()
{
    std::cout
        ...
        << "                     1: NGCHW\n"
        << "                     2: NGCHWc32\n"
        << "                     3: NGCHWc32_NGCHW_MIXED\n"
        << "                     4: NGCHWc16\n"
        << "                     5: NGCHWc16_NGCHW_MIXED\n"
        << "                     6: NDHWGC\n"
        << ")\n"
...
int profile_grouped_conv_bwd_data(int argc, char* argv[])
{
    ...
    else if(num_dim_spatial == 2 && layout == ConvLayout::NGCHW_GKCYX_NGKHW)
    {
        ...
        {
            return profile(I2, NGCHW{}, GKCYX{}, NGKHW{}, BF16{}, BF16{}, BF16{});
        }
    }
    ...
    else if(num_dim_spatial == 2 & layout == ConvLayout::NGCHW_GKCYXc32_NGKHWk32)
    {
        if(data_type == ConvDataType::F16_F16_F16)
        {
            return profile(I2, NGCHW{}, GKCYXc32{}, NGKHWk32{}, F16{}, F16{}, F16{}, true);
        }
    }
    ...
    else if(num_dim_spatial == 2 & layout == ConvLayout::NGCHWc16_GKCYXc16_NGKHW)
    {
        if(data_type == ConvDataType::F16_F16_F16)
        {
            return profile(I2, NGCHW{}, GKCYXc16{}, NGKHWk16{}, F16{}, F16{}, F16{}, true);
        }
    }
