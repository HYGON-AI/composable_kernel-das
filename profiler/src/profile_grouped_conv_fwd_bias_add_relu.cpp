...
#include "profiler/profile_grouped_conv_fwd_bias_add_relu_mmac_impl.hpp"
...
#define OP_NAME "grouped_conv_fwd_bias_add_relu"
#define OP_DESC "Grouped Convolution Forward Bias Add Relu"
...
int profile_grouped_conv_fwd_bias_add_relu(int argc, char* argv[])
{
    ...
    auto profile = [&](auto num_dim_spatial_tmp,
        ...
        bool pass = ck::profiler::profile_grouped_conv_fwd_bias_add_relu_impl<NDimSpatial,
                                                                              InLayout,
                                                                              WeiLayout,
                                                                              OutLayout,
                                                                              InDataType,
...
REGISTER_PROFILER_OPERATION(OP_NAME, OP_DESC, profile_grouped_conv_fwd_bias_add_relu);
