...
#include "ck/library/tensor_operation_instance_hcu/gpu/grouped_convolution_forward_bias_add_relu.hpp"
...
bool profile_grouped_conv_fwd_bias_add_relu_impl(int do_verification,
                                                 int init_method,
                                                 bool do_log,
                                                 bool time_kernel,
                                                 ...
                                                 int iter = 10)
{
    ...
    Tensor<OutDataType> bias({conv_param.G_, conv_param.K_});
    ...
    default:
        ...
        weight.GenerateTensorValue(GeneratorTensor_3<WeiDataType>{-0.0005, 0.0005});
        bias.GenerateTensorValue(GeneratorTensor_3<OutDataType>{-0.0001, 0.0001});
        res.GenerateTensorValue(GeneratorTensor_3<OutDataType>{-0.0001, 0.0001});
    }
    ...
    using DeviceOp =
        ck::tensor_operation::device::DeviceGroupedConvFwdBiasAddActivation<NDimSpatial,
                                                                            InLayout,
                                                                            WeiLayout,
                                                                            OutLayout,
                                                                            InDataType,
