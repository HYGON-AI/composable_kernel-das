...
#include "ck/library/tensor_operation_instance_hcu/gpu/grouped_convolution_forward_bias_relu.hpp"
                                             ...
                                             int iter            = 10)
{
    ...
    if(do_verification)
    {
        auto ref_conv = ck::tensor_operation::host::ReferenceConvFwdBiasActivation<NDimSpatial,
                                                                                   InDataType,
                                                                                   WeiDataType,
                                                                                   OutDataType,
                                                                                   InElementOp,
    ...
    using DeviceOp = ck::tensor_operation::device::DeviceGroupedConvFwdBiasActivation<NDimSpatial,
                                                                                      InLayout,
                                                                                      WeiLayout,
                                                                                      OutLayout,
                                                                                      InDataType,
