...
#include "ck/library/tensor_operation_instance_hcu/gpu/grouped_convolution_forward.hpp"
                                   ...
                                   int iter            = 10)
{
    ...
    if(profiling)
    {
        ...
        auto argument_ptr = (*it)->MakeArgumentPointer(in_device_buf.GetDeviceBuffer(),
