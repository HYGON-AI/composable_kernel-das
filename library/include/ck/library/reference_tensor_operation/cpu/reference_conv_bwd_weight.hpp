    ...
    struct Invoker : public device::BaseInvoker
    {
        ...
        float Run(const Argument& arg)
        {
                ...
                else if constexpr(NDimSpatial == 3)
                {
                    auto f_kczyx = [&](auto g, auto k, auto c, auto z, auto y, auto x) {
                        ...
                        for(std::size_t n = 0; n < arg.output_.GetLengths()[1]; ++n)
                        {
                            ...
                            {
                                auto di =
                                    static_cast<ck::long_index_t>(do_ * arg.conv_strides_[0]) +
            ...
            else
            {
                ...
                {
                    auto f_kcyx = [&](auto g, auto k, auto c, auto y, auto x, auto c_vect) {
                        std::size_t N = arg.output_.GetLengths()[1];
                            ...
                            for(std::size_t ho = 0; ho < Ho; ++ho)
                            {
                                ...
                                for(std::size_t wo = 0; wo < Wo; ++wo)
                                {
                                           ...
                                           arg.input_.GetLengths()[4])
                                    {
                                        ...
                                        size_t k_vect = k % K_VECT;

                                        arg.out_element_op_(v_out,
                                                            ck::type_convert<float>(arg.output_(
                                                                g, n, k / K_VECT, ho, wo, k_vect)));
                        ...
                        arg.weight_(g, k, c, y, x, c_vect) = ck::type_convert<WeiDataType>(v_wei);
                    };
                ...
                {
                    throw std::runtime_error("unsupported spatial dim");
                }
            }
        }
