...
#include "ck/ck.hpp"
#include "ck/tensor_operation/gpu/device/impl_ck_tile_wrapper/fused_conv_mls_wasp_kernel_v1_cbra_wrapper.hpp"
...
using Kernel = FusedConvMlsWaspKernelV1_CBRA_Wrapper<ck_tile::hcu_target_enum::gfx938,
                                                     2,
                                                     InLayout,
                                                     WeiLayout,
                                                     OutLayout,
