...
using device_instances = std::tuple<
    // clang-format off
    // for first layer
    DeviceOpF16<ConvFwdDefault, 512, 512, 64, 16, 4, 4, 16, 16, 8, 2, S<4, 128, 1>, 1, 4, true, S<4, 64, 2>, 1, 2, true, 1, 1, S<1, 1, 32, 1, 1, 4>, 8, 1>,
    DeviceOpF16<ConvFwdDefault, 512, 512, 64, 32, 8, 8, 16, 16, 8, 2, S<4, 128, 1>, 1, 8, true, S<4, 64, 2>, 1, 4, true, 1, 1, S<1, 1, 32, 1, 1, 4>, 8, 1>,
    DeviceOpF16<ConvFwdDefault, 256, 256, 64, 16, 4, 4, 16, 16, 8, 2, S<4, 64, 1>, 1, 4, true, S<4, 64, 1>, 1, 4, true, 1, 1, S<1, 1, 32, 1, 1, 4>, 8, 1>,
    DeviceOpF16<ConvFwdDefault, 256, 256, 64, 32, 8, 8, 16, 16, 8, 2, S<4, 64, 1>, 1, 8, true, S<4, 64, 1>, 1, 8, true, 1, 1, S<1, 1, 32, 1, 1, 4>, 8, 1>,
    DeviceOpF16<ConvFwdDefault, 256, 128, 64, 16, 4, 4, 16, 16, 4, 2, S<4, 64, 1>, 1, 4, true, S<4, 64, 1>, 1, 4, true, 1, 1, S<1, 1, 32, 1, 1, 4>, 8, 1>,
    DeviceOpF16<ConvFwdDefault, 256, 128, 64, 32, 8, 8, 16, 16, 4, 2, S<4, 64, 1>, 1, 8, true, S<4, 64, 1>, 1, 8, true, 1, 1, S<1, 1, 32, 1, 1, 4>, 8, 1>
    // clang-format on
    >;
