...
#include "ck/ck.hpp"
#include "ck/tensor_operation/gpu/device/impl_ck_tile_wrapper/fused_conv_wasp_kernel_v2r1_cbra_wrapper.hpp"
...
using Kernel = FusedConvWaspKernelV2R1_CBRA_Wrapper<2,
                                                    InLayout,
                                                    WeiLayout,
                                                    OutLayout,
                                                    ck::half_t,
