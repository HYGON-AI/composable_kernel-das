...
std::string get_conv_param_parser_helper_msg(bool wrw)
{
    std::string msg;
    ...
    if(wrw)
        msg += " SplitK\n";
    msg += " [<instance name>] (optional)\n";

    return msg;
}

ck::utils::conv::ConvParam
parse_conv_param(int num_dim_spatial, int arg_idx, char* const argv[], bool with_instance_name)
{
